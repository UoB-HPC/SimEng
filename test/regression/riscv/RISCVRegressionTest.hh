...
#define RISCV_CONFIG                                                          \
  ("{Core: {ISA: rv64, Simulation-Mode: emulation, Clock-Frequency: 2.5}, "   \
   ...
   "500000}, Register-Set: {GeneralPurpose-Count: 154, FloatingPoint-Count: " \
   "90}, Pipeline-Widths: {Commit: 4, Dispatch-Rate: 4, FrontEnd: 4, "        \
   ...
   "2}, LSQ-L1-Interface: {Access-Latency: 4, Exclusive: False, "             \
