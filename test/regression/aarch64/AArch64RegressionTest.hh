...
#define AARCH64_CONFIG                                                         \
  ("{Core: {Simulation-Mode: emulation, Clock-Frequency: 2.5, "                \
   ...
   "Commit:4, FrontEnd: 4, LSQ-Completion: 2}, Queue-Sizes: {ROB: 180, Load: " \
   "64, Store: 36}, Branch-Predictor: {BTB-Tag-Bits: 11, "                     \
   ...
   "Ports: [0]}}, Execution-Units: {'0': {Pipelined: true}}, Statistics: "     \
   "{Dump-File: ./stats-dump.txt}}")
