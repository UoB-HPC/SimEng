...
TEST_P(InstNeon, tbl) {
  ...
  CHECK_NEON(7, uint8_t,{ 0x00, 0x00, 0x00, 0x22, 0x00, 0x44, 0x00, 0x00, 0x00, 0xAA, 0x00, 0xBB, 0x00, 0xCC, 0x00, 0xDD});
  ...
  CHECK_NEON(7, uint8_t,{ 0x00, 0x00, 0x00, 0x22, 0x00, 0xEE, 0x00, 0x00, 
		  	  0x00, 0x11, 0x00, 0x22, 0x00, 0x00, 0x00, 0xFF});
  ...
  CHECK_NEON(7, uint8_t,{ 0x00, 0xEF, 0x00, 0x22, 0x00, 0xBA, 0x00, 0x00, 
		  	  0x00, 0x11, 0x00, 0xBA, 0x00, 0x00, 0x00, 0xFF});
  ...
  CHECK_NEON(7, uint8_t,{ 0xF0, 0xEF, 0x00, 0x22, 0x00, 0xBA, 0x00, 0x00, 
		  	  0x00, 0x11, 0x00, 0xBA, 0x00, 0x00, 0xCE, 0xFF});
}
...
TEST_P(InstNeon, rev) {
  ...
  CHECK_NEON(1, uint8_t, {0x07, 0x06, 0x05, 0x04, 0x03, 0x02, 0x01,0x00, 0x0f, 0x0e, 0x0d, 0x0c, 0x0b,0x0a,0x09,0x08,});
  CHECK_NEON(2, uint16_t, {0x0706, 0x0504, 0x0302, 0x0100, 0x0000, 0x0000,0x0000,0x0000});
  CHECK_NEON(3, uint16_t, {0x0706, 0x0504, 0x0302, 0x0100, 0x0f0e, 0x0d0c, 0x0b0a, 0x0908});
  CHECK_NEON(4, uint32_t, {0x7060504, 0x3020100, 0x0, 0x0});
  CHECK_NEON(5, uint32_t, {0x7060504, 0x3020100, 0xf0e0d0c, 0xb0a0908});
  CHECK_NEON(6, uint8_t, {0x07, 0x06, 0x05, 0x04, 0x03, 0x02, 0x01,0x00,0x00,0x00,0x00});
  ...
  CHECK_NEON(1, uint8_t, {0x03, 0x02, 0x01, 0x00, 0x07, 0x06, 0x05, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00});
  CHECK_NEON(2, uint8_t, {0x03, 0x02, 0x01, 0x00, 0x07, 0x06, 0x05, 0x04, 0x0b, 0x0a, 0x09, 0x08, 0x0f, 0x0e, 0x0d, 0x0c});
  CHECK_NEON(3, uint16_t, {0x0302, 0x0100, 0x0706, 0x0504, 0x0000, 0x0000, 0x0000, 0x0000});
  CHECK_NEON(4, uint16_t, {0x0302, 0x0100, 0x0706, 0x0504, 0x0b0a, 0x0908, 0x0f0e, 0x0d0c});
  ...
  CHECK_NEON(1,uint8_t,{0x01, 0x00, 0x03, 0x02, 0x05, 0x04, 0x07, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00});
  CHECK_NEON(2,uint8_t,{0x01, 0x00, 0x03, 0x02, 0x05, 0x04, 0x07, 0x06, 0x09, 0x08, 0x0b, 0x0a, 0x0d, 0x0c, 0x0f, 0xe});
}
...
TEST_P(InstNeon, trn) {
  ...
  heap64[1] = 0x1F1D1B1917151311;
	...
	CHECK_NEON(2, uint8_t, {0x0, 0x1, 0x4, 0x5, 0x8, 0x9, 0xc, 0xd, 0x10, 0x11, 0x14, 0x15, 0x18, 0x19, 0x1c, 0x1d});
	CHECK_NEON(3, uint8_t, {0x0, 0x1, 0x4, 0x5, 0x8, 0x9, 0xc, 0xd, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0});
	CHECK_NEON(4, uint16_t, {0x200, 0x301, 0xa08, 0xb09, 0x0, 0x0, 0x0, 0x0});
	CHECK_NEON(5, uint16_t, {0x200, 0x301, 0xa08, 0xb09, 0x1210, 0x1311, 0x1a18, 0x1b19});
	...
	CHECK_NEON(2, uint8_t, {0x2, 0x3, 0x6, 0x7, 0xa, 0xb, 0xe, 0xf, 0x12, 0x13, 0x16, 0x17, 0x1a, 0x1b, 0x1e, 0x1f});
	CHECK_NEON(3, uint8_t, {0x2, 0x3, 0x6, 0x7, 0xa, 0xb, 0xe, 0xf, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0});
	CHECK_NEON(4, uint16_t, {0x604, 0x705, 0xe0c, 0xf0d, 0x0, 0x0, 0x0, 0x0});
	CHECK_NEON(5, uint16_t, {0x604, 0x705, 0xe0c, 0xf0d, 0x1614, 0x1715, 0x1e1c, 0x1f1d});
...
TEST_P(InstNeon, uzp) {
  ...
  heap64[1] = 0x1F1D1B1917151311;
	...
	CHECK_NEON(2, uint8_t, {0x0, 0x4, 0x8, 0xc, 0x10, 0x14, 0x18, 0x1c, 0x1, 0x5, 0x9, 0xd, 0x11, 0x15, 0x19, 0x1d} );
	CHECK_NEON(3, uint8_t, {0x0, 0x4, 0x8, 0xc, 0x1, 0x5, 0x9, 0xd, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0} );
	CHECK_NEON(4, uint16_t,{0x200, 0xa08, 0x301, 0xb09, 0x0, 0x0, 0x0, 0x0} );
	CHECK_NEON(5, uint16_t,{0x200, 0xa08, 0x1210, 0x1a18, 0x301, 0xb09, 0x1311, 0x1b19} );
	CHECK_NEON(6, uint32_t,{0x6040200, 0x7050301, 0x0, 0x0} );
	...
	CHECK_NEON(2, uint8_t, {0x2, 0x6, 0xa, 0xe, 0x12, 0x16, 0x1a, 0x1e, 0x3, 0x7, 0xb, 0xf, 0x13, 0x17, 0x1b, 0x1f});
	CHECK_NEON(3, uint8_t, {0x2, 0x6, 0xa, 0xe, 0x3, 0x7, 0xb, 0xf, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0} );
	CHECK_NEON(4, uint16_t, {0x604, 0xe0c, 0x705, 0xf0d, 0x0, 0x0, 0x0, 0x0});
	CHECK_NEON(5, uint16_t,{0x604, 0xe0c, 0x1614, 0x1e1c, 0x705, 0xf0d, 0x1715, 0x1f1d} );
	CHECK_NEON(6, uint32_t,{0xe0c0a08, 0xf0d0b09, 0x0, 0x0});
