...
TEST_P(MicroOp, storePairD) {
  ...
  EXPECT_EQ(getMemoryValue<double>(process_->getStackPointer() - 1024),
            -5.0);
  EXPECT_EQ(getMemoryValue<double>(process_->getStackPointer() - 1016),
            -3.5);
  EXPECT_EQ(getMemoryValue<double>(process_->getStackPointer() - 1008),
            3.5);
  EXPECT_EQ(getMemoryValue<double>(process_->getStackPointer() - 1000),
            5.0);
  EXPECT_EQ(getMemoryValue<double>(process_->getStackPointer() - 992),
            -1.5);
  EXPECT_EQ(getMemoryValue<double>(process_->getStackPointer() - 984),
            -0.5);
  EXPECT_EQ(getMemoryValue<double>(process_->getStackPointer() - 976),
            0.5);
  EXPECT_EQ(getMemoryValue<double>(process_->getStackPointer() - 968),
            1.5);
}
...
TEST_P(MicroOp, storePairS) {
  ...
  EXPECT_EQ(getMemoryValue<float>(process_->getStackPointer() - 1024),
            -5.0f);
  EXPECT_EQ(getMemoryValue<float>(process_->getStackPointer() - 1020),
            -3.5f);
  EXPECT_EQ(getMemoryValue<float>(process_->getStackPointer() - 1016),
            3.5f);
  EXPECT_EQ(getMemoryValue<float>(process_->getStackPointer() - 1012),
            5.0f);
  EXPECT_EQ(getMemoryValue<float>(process_->getStackPointer() - 1008),
            -1.5f);
  EXPECT_EQ(getMemoryValue<float>(process_->getStackPointer() - 1004),
            -0.5f);
  EXPECT_EQ(getMemoryValue<float>(process_->getStackPointer() - 1000),
            0.5f);
  EXPECT_EQ(getMemoryValue<float>(process_->getStackPointer() - 996),
            1.5f);
}
...
TEST_P(MicroOp, storePairW) {
  ...
  EXPECT_EQ(getMemoryValue<uint32_t>(process_->getStackPointer() - 1024),
            12);
  EXPECT_EQ(getMemoryValue<uint32_t>(process_->getStackPointer() - 1020),
            24);
  EXPECT_EQ(getMemoryValue<uint32_t>(process_->getStackPointer() - 1016),
            84);
  EXPECT_EQ(getMemoryValue<uint32_t>(process_->getStackPointer() - 1012),
            96);
  EXPECT_EQ(getMemoryValue<uint32_t>(process_->getStackPointer() - 1008),
            36);
  EXPECT_EQ(getMemoryValue<uint32_t>(process_->getStackPointer() - 1004),
            48);
  EXPECT_EQ(getMemoryValue<uint32_t>(process_->getStackPointer() - 1000),
            60);
  EXPECT_EQ(getMemoryValue<uint32_t>(process_->getStackPointer() - 996),
            72);
}
...
TEST_P(MicroOp, storeB) {
  ...
  EXPECT_EQ(getMemoryValue<uint8_t>(process_->getStackPointer() - 1024),
            0xAB);
  EXPECT_EQ(getMemoryValue<uint8_t>(process_->getStackPointer() - 1023),
            0xFE);
  EXPECT_EQ(getMemoryValue<uint8_t>(process_->getStackPointer() - 1022),
            0xBA);
  EXPECT_EQ(getMemoryValue<uint8_t>(process_->getStackPointer() - 1021),
            0xCA);
}
