...
simos.addParams({
    "num_cores": 12,
    "simeng_config_path": "/home/br-jjones/simulation/SimEng/isambard_DEMO_RISCV-12.yaml",
...
link_c1_l1Dcache.connect( (c1_dataInterface, "port", "1ps"), (c1_l1Dcache, "high_network_0", "1ps") )
link_c1_l1Icache = sst.Link("link_c1_l1Icache_link")
link_c1_l1Icache.connect( (c1_instrInterface, "port", "1ps"), (c1_l1Icache, "high_network_0", "1ps") )
link_c1_router = sst.Link("link_c1_router")
link_c1_router.connect((c1_netInterface, "rtr_port", "1ps"), (router, "port2", "1ps"))

link_c1_l1D_l2bus = sst.Link("link_c1_l1D_l2bus_link")
link_c1_l1D_l2bus.connect( (c1_l1Dcache, "low_network_0", "1ps"), (bus_0_l1_l2, "high_network_4", "1ps") )
link_c1_l1I_l2bus = sst.Link("link_c1_l1I_l2bus_link")
link_c1_l1I_l2bus.connect( (c1_l1Icache, "low_network_0", "1ps"), (bus_0_l1_l2, "high_network_5", "1ps") )


link_c2_l1Dcache = sst.Link("link_c2_l1Dcache_link")
link_c2_l1Dcache.connect( (c2_dataInterface, "port", "1ps"), (c2_l1Dcache, "high_network_0", "1ps") )
link_c2_l1Icache = sst.Link("link_c2_l1Icache_link")
link_c2_l1Icache.connect( (c2_instrInterface, "port", "1ps"), (c2_l1Icache, "high_network_0", "1ps") )
link_c2_router = sst.Link("link_c2_router")
link_c2_router.connect((c2_netInterface, "rtr_port", "1ps"), (router, "port3", "1ps"))

link_c2_l1D_l2bus = sst.Link("link_c2_l1D_l2bus_link")
link_c2_l1D_l2bus.connect( (c2_l1Dcache, "low_network_0", "1ps"), (bus_0_l1_l2, "high_network_6", "1ps") )
link_c2_l1I_l2bus = sst.Link("link_c2_l1I_l2bus_link")
link_c2_l1I_l2bus.connect( (c2_l1Icache, "low_network_0", "1ps"), (bus_0_l1_l2, "high_network_7", "1ps") )


link_c3_l1Dcache = sst.Link("link_c3_l1Dcache_link")
link_c3_l1Dcache.connect( (c3_dataInterface, "port", "1ps"), (c3_l1Dcache, "high_network_0", "1ps") )
link_c3_l1Icache = sst.Link("link_c3_l1Icache_link")
link_c3_l1Icache.connect( (c3_instrInterface, "port", "1ps"), (c3_l1Icache, "high_network_0", "1ps") )
link_c3_router = sst.Link("link_c3_router")
link_c3_router.connect((c3_netInterface, "rtr_port", "1ps"), (router, "port4", "1ps"))

link_c3_l1D_l2bus = sst.Link("link_c3_l1D_l2bus_link")
link_c3_l1D_l2bus.connect( (c3_l1Dcache, "low_network_0", "1ps"), (bus_0_l1_l2, "high_network_8", "1ps") )
link_c3_l1I_l2bus = sst.Link("link_c3_l1I_l2bus_link")
link_c3_l1I_l2bus.connect( (c3_l1Icache, "low_network_0", "1ps"), (bus_0_l1_l2, "high_network_9", "1ps") )


link_c4_l1Dcache = sst.Link("link_c4_l1Dcache_link")
link_c4_l1Dcache.connect( (c4_dataInterface, "port", "1ps"), (c4_l1Dcache, "high_network_0", "1ps") )
link_c4_l1Icache = sst.Link("link_c4_l1Icache_link")
link_c4_l1Icache.connect( (c4_instrInterface, "port", "1ps"), (c4_l1Icache, "high_network_0", "1ps") )
link_c4_router = sst.Link("link_c4_router")
link_c4_router.connect((c4_netInterface, "rtr_port", "1ps"), (router, "port5", "1ps"))

link_c4_l1D_l2bus = sst.Link("link_c4_l1D_l2bus_link")
link_c4_l1D_l2bus.connect( (c4_l1Dcache, "low_network_0", "1ps"), (bus_0_l1_l2, "high_network_10", "1ps") )
link_c4_l1I_l2bus = sst.Link("link_c4_l1I_l2bus_link")
link_c4_l1I_l2bus.connect( (c4_l1Icache, "low_network_0", "1ps"), (bus_0_l1_l2, "high_network_11", "1ps") )


link_c5_l1Dcache = sst.Link("link_c5_l1Dcache_link")
link_c5_l1Dcache.connect( (c5_dataInterface, "port", "1ps"), (c5_l1Dcache, "high_network_0", "1ps") )
link_c5_l1Icache = sst.Link("link_c5_l1Icache_link")
link_c5_l1Icache.connect( (c5_instrInterface, "port", "1ps"), (c5_l1Icache, "high_network_0", "1ps") )
link_c5_router = sst.Link("link_c5_router")
link_c5_router.connect((c5_netInterface, "rtr_port", "1ps"), (router, "port6", "1ps"))

link_c5_l1D_l2bus = sst.Link("link_c5_l1D_l2bus_link")
link_c5_l1D_l2bus.connect( (c5_l1Dcache, "low_network_0", "1ps"), (bus_0_l1_l2, "high_network_12", "1ps") )
link_c5_l1I_l2bus = sst.Link("link_c5_l1I_l2bus_link")
link_c5_l1I_l2bus.connect( (c5_l1Icache, "low_network_0", "1ps"), (bus_0_l1_l2, "high_network_13", "1ps") )


link_c6_l1Dcache = sst.Link("link_c6_l1Dcache_link")
link_c6_l1Dcache.connect( (c6_dataInterface, "port", "1ps"), (c6_l1Dcache, "high_network_0", "1ps") )
link_c6_l1Icache = sst.Link("link_c6_l1Icache_link")
link_c6_l1Icache.connect( (c6_instrInterface, "port", "1ps"), (c6_l1Icache, "high_network_0", "1ps") )
link_c6_router = sst.Link("link_c6_router")
link_c6_router.connect((c6_netInterface, "rtr_port", "1ps"), (router, "port7", "1ps"))

link_c6_l1D_l2bus = sst.Link("link_c6_l1D_l2bus_link")
link_c6_l1D_l2bus.connect( (c6_l1Dcache, "low_network_0", "1ps"), (bus_0_l1_l2, "high_network_14", "1ps") )
link_c6_l1I_l2bus = sst.Link("link_c6_l1I_l2bus_link")
link_c6_l1I_l2bus.connect( (c6_l1Icache, "low_network_0", "1ps"), (bus_0_l1_l2, "high_network_15", "1ps") )


link_c7_l1Dcache = sst.Link("link_c7_l1Dcache_link")
link_c7_l1Dcache.connect( (c7_dataInterface, "port", "1ps"), (c7_l1Dcache, "high_network_0", "1ps") )
link_c7_l1Icache = sst.Link("link_c7_l1Icache_link")
link_c7_l1Icache.connect( (c7_instrInterface, "port", "1ps"), (c7_l1Icache, "high_network_0", "1ps") )
link_c7_router = sst.Link("link_c7_router")
link_c7_router.connect((c7_netInterface, "rtr_port", "1ps"), (router, "port8", "1ps"))

link_c7_l1D_l2bus = sst.Link("link_c7_l1D_l2bus_link")
link_c7_l1D_l2bus.connect( (c7_l1Dcache, "low_network_0", "1ps"), (bus_0_l1_l2, "high_network_16", "1ps") )
link_c7_l1I_l2bus = sst.Link("link_c7_l1I_l2bus_link")
link_c7_l1I_l2bus.connect( (c7_l1Icache, "low_network_0", "1ps"), (bus_0_l1_l2, "high_network_17", "1ps") )


link_c8_l1Dcache = sst.Link("link_c8_l1Dcache_link")
link_c8_l1Dcache.connect( (c8_dataInterface, "port", "1ps"), (c8_l1Dcache, "high_network_0", "1ps") )
link_c8_l1Icache = sst.Link("link_c8_l1Icache_link")
link_c8_l1Icache.connect( (c8_instrInterface, "port", "1ps"), (c8_l1Icache, "high_network_0", "1ps") )
link_c8_router = sst.Link("link_c8_router")
link_c8_router.connect((c8_netInterface, "rtr_port", "1ps"), (router, "port9", "1ps"))

link_c8_l1D_l2bus = sst.Link("link_c8_l1D_l2bus_link")
link_c8_l1D_l2bus.connect( (c8_l1Dcache, "low_network_0", "1ps"), (bus_0_l1_l2, "high_network_18", "1ps") )
link_c8_l1I_l2bus = sst.Link("link_c8_l1I_l2bus_link")
link_c8_l1I_l2bus.connect( (c8_l1Icache, "low_network_0", "1ps"), (bus_0_l1_l2, "high_network_19", "1ps") )


link_c9_l1Dcache = sst.Link("link_c9_l1Dcache_link")
link_c9_l1Dcache.connect( (c9_dataInterface, "port", "1ps"), (c9_l1Dcache, "high_network_0", "1ps") )
link_c9_l1Icache = sst.Link("link_c9_l1Icache_link")
link_c9_l1Icache.connect( (c9_instrInterface, "port", "1ps"), (c9_l1Icache, "high_network_0", "1ps") )
link_c9_router = sst.Link("link_c9_router")
link_c9_router.connect((c9_netInterface, "rtr_port", "1ps"), (router, "port10", "1ps"))

link_c9_l1D_l2bus = sst.Link("link_c9_l1D_l2bus_link")
link_c9_l1D_l2bus.connect( (c9_l1Dcache, "low_network_0", "1ps"), (bus_0_l1_l2, "high_network_20", "1ps") )
link_c9_l1I_l2bus = sst.Link("link_c9_l1I_l2bus_link")
link_c9_l1I_l2bus.connect( (c9_l1Icache, "low_network_0", "1ps"), (bus_0_l1_l2, "high_network_21", "1ps") )


link_c10_l1Dcache = sst.Link("link_c10_l1Dcache_link")
link_c10_l1Dcache.connect( (c10_dataInterface, "port", "1ps"), (c10_l1Dcache, "high_network_0", "1ps") )
link_c10_l1Icache = sst.Link("link_c10_l1Icache_link")
link_c10_l1Icache.connect( (c10_instrInterface, "port", "1ps"), (c10_l1Icache, "high_network_0", "1ps") )
link_c10_router = sst.Link("link_c10_router")
link_c10_router.connect((c10_netInterface, "rtr_port", "1ps"), (router, "port11", "1ps"))

link_c10_l1D_l2bus = sst.Link("link_c10_l1D_l2bus_link")
link_c10_l1D_l2bus.connect( (c10_l1Dcache, "low_network_0", "1ps"), (bus_0_l1_l2, "high_network_22", "1ps") )
link_c10_l1I_l2bus = sst.Link("link_c10_l1I_l2bus_link")
link_c10_l1I_l2bus.connect( (c10_l1Icache, "low_network_0", "1ps"), (bus_0_l1_l2, "high_network_23", "1ps") )


link_c11_l1Dcache = sst.Link("link_c11_l1Dcache_link")
link_c11_l1Dcache.connect( (c11_dataInterface, "port", "1ps"), (c11_l1Dcache, "high_network_0", "1ps") )
link_c11_l1Icache = sst.Link("link_c11_l1Icache_link")
link_c11_l1Icache.connect( (c11_instrInterface, "port", "1ps"), (c11_l1Icache, "high_network_0", "1ps") )
link_c11_router = sst.Link("link_c11_router")
link_c11_router.connect((c11_netInterface, "rtr_port", "1ps"), (router, "port12", "1ps"))

link_c11_l1D_l2bus = sst.Link("link_c11_l1D_l2bus_link")
link_c11_l1D_l2bus.connect( (c11_l1Dcache, "low_network_0", "1ps"), (bus_0_l1_l2, "high_network_24", "1ps") )
link_c11_l1I_l2bus = sst.Link("link_c11_l1I_l2bus_link")
link_c11_l1I_l2bus.connect( (c11_l1Icache, "low_network_0", "1ps"), (bus_0_l1_l2, "high_network_25", "1ps") )
