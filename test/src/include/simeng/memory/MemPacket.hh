...
static constexpr uint16_t IsStoreAddrMask = 0b0000000000010000;
static constexpr uint16_t IsStoreDataMask = 0b0000000000001000;
...
class MemPacket {
 public:
  ...
  inline bool isStoreAddr() const { return metadata_ & IsStoreAddrMask; }

  inline bool isStoreData() const { return metadata_ & IsStoreDataMask; }
  ...
  inline void markAsStoreAddr() { metadata_ = metadata_ | IsStoreAddrMask; }

  inline void markAsStoreData() { metadata_ = metadata_ | IsStoreDataMask; }
