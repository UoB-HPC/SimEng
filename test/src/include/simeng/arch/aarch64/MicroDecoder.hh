...
class MicroDecoder {
 public:
  ...
  Instruction createLdrUop(const Architecture& architecture, arm64_reg dest,
                           ...
                           bool lastMicroOp = false, int microOpIndex = 0,
                           uint8_t dataSize = 0, uint8_t totalDataSize = 0,
                           bool isSigned = false);
   ...
   */
  Instruction createStrUop_predicated(
      const Architecture& architecture, arm64_op_mem mem, arm64_reg pred,
      csh capstoneHandle, bool lastMicroOp = false, int microOpIndex = 0,
      uint8_t dataSize = 0, uint8_t totalDataSize = 0);
