...
class A64FXPortAllocator : public PortAllocator {
 public:
  ...
  void enablePrint(bool enable) override { print_ = enable; }
 ...
 private:
  ...
  std::vector<uint16_t> dispatchSlots_;
  ...
  int64_t cond1Threshold_ = 20;
  int64_t cond2Threshold_ = 20;
  int64_t cond3Threshold_ = 10;
