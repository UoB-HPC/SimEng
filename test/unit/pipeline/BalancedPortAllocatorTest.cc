...
TEST(BalancedPortAllocatorTest, AllocateLimited) {
  auto limited = BalancedPortAllocator({{{{0, 0}}}, {{{1, 0}}}});
...
TEST(BalancedPortAllocatorTest, BalanceEven) {
  auto portAllocator = BalancedPortAllocator({{{{0, 0}}}, {{{0, 0}}}});
...
TEST(BalancedPortAllocatorTest, BalanceUneven) {
  auto portAllocator =
      BalancedPortAllocator({{{{0, 0}}, {{1, 0}}}, {{{0, 0}}}});
...
TEST(BalancedPortAllocatorTest, ComplexSharedPorts) {
  auto portAllocator = BalancedPortAllocator({
      ...
      {{{4, 0}, {1, 1}, {2, 1}}},                                      // PORT 2
      {{{0, 0}, {1, 1}, {3, 1}}},                                      // PORT 3
      {{{5, 0}, {1, 1}, {4, 1}}, {{0, 0}}},                            // PORT 4
      {{{5, 0}, {1, 1}, {4, 1}}, {{6, 0}, {1, 1}, {4, 1}}, {{0, 0}}},  // PORT 5
      {{{7, 0}}}                                                       // PORT 6
  });
