...
InstructionMetadata::InstructionMetadata(const cs_insn& insn)
  ...
  switch (opcode) {
    ...
    //   // Post offset register is not put as mem.index
    //   if (operands[3].type == AARCH64_OP_REG) {
    //     operands[2].mem.index = operands[3].reg;
    //     operands[3].type = AARCH64_OP_INVALID;
    //   }
    //   break;
    case Opcode::AArch64_FCVTNv4i32:
      // Wrong access type for destinatio operand
      operands[0].access = CS_AC_WRITE;
      break;
    ...
    //   // Post offset register is not put as mem.index
    //   if (operands[2].type == AARCH64_OP_REG) {
    //     operands[1].mem.index = operands[2].reg;
    //     operands[2].type = AARCH64_OP_INVALID;
    //   }
    //   break;
    //   case Opcode::AArch64_ST1i16_POST:
    //     [[fallthrough]];
...
void InstructionMetadata::revertAliasing() {
  ...
  //       }
  //       return aliasNYI();
  //     case AARCH64_INS_CINV:
  //       return aliasNYI();
  //     case AARCH64_INS_CMN:
  ...
  //         // 64-bit version
  //         operands[0].reg = AARCH64_REG_XZR;
  //       } else {
  //         // 32-bit version
  //         operands[0].reg = AARCH64_REG_WZR;
  //       }
  //       return;
  //     case AARCH64_INS_CMP:
  ...
  //         operands[2].type = AARCH64_OP_REG;
  //         operands[2].access = CS_AC_READ;
  //         operands[2].shift = {AARCH64_SFT_INVALID, 0};

  //         if (opcode == Opcode::AArch64_CSINCWr) {
  //           operands[1].reg = AARCH64_REG_WZR;
  //           operands[2].reg = AARCH64_REG_WZR;
  //         } else {
  //           operands[1].reg = AARCH64_REG_XZR;
  //           operands[2].reg = AARCH64_REG_XZR;
  //         }
  ...
  //         operands[3].type = AARCH64_OP_REG;
  //         operands[3].access = CS_AC_READ;
  //         operands[3].reg = AARCH64_REG_XZR;
  //         return;
  //       }
  ...
  //         operands[3].type = AARCH64_OP_REG;
  //         operands[3].access = CS_AC_READ;
  //         operands[3].reg = AARCH64_REG_WZR;
  //         return;
  //       }
  //       return aliasNYI();
  ...
  //         operands[2].imm = 0;
  //         operands[2].access = CS_AC_READ;
  //         operands[2].shift.type = AARCH64_SFT_INVALID;
  //         operands[2].vas = AARCH64_VAS_INVALID;
  //         operands[2].vector_index = -1;
  //         return;
  //       }
  //       if (opcode == Opcode::AArch64_DUPi8 || opcode ==
  //       Opcode::AArch64_DUPi16
  //       ||
  ...
  //           switch (specifier) {
  //             case 'b':
  //               operands[0].vas = AARCH64_VAS_1B;
  //               break;
  //             case 'h':
  //               operands[0].vas = AARCH64_VAS_1H;
  //               break;
  //             case 's':
  //               operands[0].vas = AARCH64_VAS_1S;
  //               break;
  //             case 'd':
  //               operands[0].vas = AARCH64_VAS_1D;
  //               break;
  ...
  //         operands[1].reg = static_cast<aarch64_reg>(
  //             AARCH64_REG_Z0 + stoi(operandStr.substr(start, end)));
  ...
  //         if (mnemonic[0] == 'm') {
  //           // SEL instructions id sometimes set as AARCH64_INS_MOV even if
  ...
  //         operands[1].access = CS_AC_READ;
  //         operands[1].shift = {AARCH64_SFT_LSL, 0};
  //         return;
  //       }
  ...
  //       }
  //       return aliasNYI();
  //     case AARCH64_INS_NGC:
  //       return aliasNYI();
  //     case AARCH64_INS_NGCS:
  //       return aliasNYI();
  ...
  //           operands[1] = operands[0];
  //           operands[1].access = CS_AC_READ;
  //           operands[0].type = AARCH64_OP_SYS;
  //           operands[0].sys = AARCH64_DC_ZVA;
  //           operands[2].type = AARCH64_OP_REG_MRS;
  //           operands[2].access = CS_AC_READ;
  //           operands[2].imm = AARCH64_SYSREG_DCZID_EL0;
  //           return;
  //         }
  //       }
  //       return aliasNYI();
  //     }
  //     case AARCH64_INS_TLBI:
  //       return aliasNYI();
  //     case AARCH64_INS_TST:
