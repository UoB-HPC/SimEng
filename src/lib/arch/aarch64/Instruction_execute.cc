  ...
  if (isMicroOp_) {
    switch (microOpcode_) {
      ...
      case MicroOpcode::OFFSET_IMM: {
        results[0] =
            sourceValues_[0].get<uint64_t>() + metadata.operands[2].imm;
        break;
      }
    ...
    switch (metadata.opcode) {
      ...
      case Opcode::AArch64_ADDPv16i8: {  // addp vd.16b, vn.16b, vm.16b
        results[0] = neonHelp::vecAddp_3ops<uint8_t, 16>(sourceValues_);
        break;
      }
      case Opcode::AArch64_ADDPv2i64: {  // addp vd.2d, vn.2d, vm.2d
        results[0] = neonHelp::vecAddp_3ops<uint64_t, 2>(sourceValues_);
        break;
      }
      case Opcode::AArch64_ADDPv2i64p: {  // addp dd, vn.2d
        results[0] = neonHelp::vecSumElems_2ops<uint64_t, 2>(sourceValues_);
        break;
      }
      case Opcode::AArch64_ADDPv4i32: {  // addp vd.4s, vn.4s, vm.4s
        results[0] = neonHelp::vecAddp_3ops<uint32_t, 4>(sourceValues_);
        break;
      }
      case Opcode::AArch64_ADDPv8i16: {  // addp vd.8h, vn.8h, vm.8h
        results[0] = neonHelp::vecAddp_3ops<uint16_t, 8>(sourceValues_);
        break;
      }
      case Opcode::AArch64_ADDSWri: {  // adds wd, wn, #imm{, shift}
        auto [result, nzcv] = arithmeticHelp::addShift_imm<uint32_t>(
            sourceValues_, metadata, true);
        results[0] = nzcv;
        results[1] = {result, 8};
        break;
      }
      ...
      case Opcode::AArch64_ADDVv4i16v: {  // addv hd, vn.4h
        results[0] = neonHelp::vecSumElems_2ops<uint16_t, 4>(sourceValues_);
        break;
      }
      case Opcode::AArch64_ADDVv4i32v: {  // addv sd, vn.4s
        results[0] = neonHelp::vecSumElems_2ops<uint32_t, 4>(sourceValues_);
        break;
      }
      case Opcode::AArch64_ADDVv8i8v: {  // addv bd, vn.8b
        results[0] = neonHelp::vecSumElems_2ops<uint8_t, 8>(sourceValues_);
        break;
      }
      case Opcode::AArch64_ADDWri: {  // add wd, wn, #imm{, shift}
        auto [result, nzcv] = arithmeticHelp::addShift_imm<uint32_t>(
            sourceValues_, metadata, false);
        results[0] = {result, 8};
        break;
      }
      ...
      case Opcode::AArch64_ADD_ZI_B: {  // add zdn.b, zdn.b, imm{, shift}
        results[0] =
            sveHelp::sveAdd_imm<uint8_t>(sourceValues_, metadata, VL_bits);
        break;
      }
      case Opcode::AArch64_ADD_ZI_D: {  // add zdn.d, zdn.d, imm{, shift}
        results[0] =
            sveHelp::sveAdd_imm<uint64_t>(sourceValues_, metadata, VL_bits);
        break;
      }
      case Opcode::AArch64_ADD_ZI_H: {  // add zdn.h zdn.h, imm{, shift}
        results[0] =
            sveHelp::sveAdd_imm<uint16_t>(sourceValues_, metadata, VL_bits);
        break;
      }
      case Opcode::AArch64_ADD_ZI_S: {  // add zdn.s, zdn.s, imm{, shift}
        results[0] =
            sveHelp::sveAdd_imm<uint32_t>(sourceValues_, metadata, VL_bits);
        break;
      }
      ...
      case Opcode::AArch64_ADD_ZZZ_B: {  // add zd.b, zn.b, zm.b
        results[0] = sveHelp::sveAdd_3ops<uint8_t>(sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_ADD_ZZZ_D: {  // add zd.d, zn.d, zm.d
        results[0] = sveHelp::sveAdd_3ops<uint64_t>(sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_ADD_ZZZ_H: {  // add zd.h, zn.h, zm.h
        results[0] = sveHelp::sveAdd_3ops<uint16_t>(sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_ADD_ZZZ_S: {  // add zd.s, zn.s, zm.s
        results[0] = sveHelp::sveAdd_3ops<uint32_t>(sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_ADDv16i8: {  // add vd.16b, vn.16b, vm.16b
        results[0] = neonHelp::vecAdd_3ops<uint8_t, 16>(sourceValues_);
        break;
      }
      case Opcode::AArch64_ADDv1i64: {  // add dd, dn, dm
        results[0] = neonHelp::vecAdd_3ops<uint64_t, 1>(sourceValues_);
        break;
      }
      case Opcode::AArch64_ADDv2i32: {  // add vd.2s, vn.2s, vm.2s
        results[0] = neonHelp::vecAdd_3ops<uint32_t, 2>(sourceValues_);
        break;
      }
      case Opcode::AArch64_ADDv2i64: {  // add vd.2d, vn.2d, vm.2d
        results[0] = neonHelp::vecAdd_3ops<uint64_t, 2>(sourceValues_);
        break;
      }
      case Opcode::AArch64_ADDv4i16: {  // add vd.4h, vn.4h, vm.4h
        results[0] = neonHelp::vecAdd_3ops<uint16_t, 4>(sourceValues_);
        break;
      }
      case Opcode::AArch64_ADDv4i32: {  // add vd.4s, vn.4s, vm.4s
        results[0] = neonHelp::vecAdd_3ops<uint32_t, 4>(sourceValues_);
        break;
      }
      case Opcode::AArch64_ADDv8i16: {  // add vd.8h, vn.8h, vm.8h
        results[0] = neonHelp::vecAdd_3ops<uint16_t, 8>(sourceValues_);
        break;
      }
      case Opcode::AArch64_ADDv8i8: {  // add vd.8b, vn.8b, vm.8b
        results[0] = neonHelp::vecAdd_3ops<uint8_t, 8>(sourceValues_);
        break;
      }
      ...
      case Opcode::AArch64_ADR_LSL_ZZZ_D_3: {  // adr zd.d, [zn.d, zm.d, lsl #3]
        results[0] = sveHelp::sveAdr_packedOffsets<uint64_t>(sourceValues_,
                                                             metadata, VL_bits);
        break;
      }
      ...
      case Opcode::AArch64_ADR_LSL_ZZZ_S_3: {  // adr zd.s, [zn.s, zm.s, lsl #3]
        results[0] = sveHelp::sveAdr_packedOffsets<uint32_t>(sourceValues_,
                                                             metadata, VL_bits);
        break;
      }
      ...
      case Opcode::AArch64_ASRVWr: {  // asrv wd, wn, wm
        results[0] = {logicalHelp::asrv_3gpr<int32_t>(sourceValues_), 8};
        break;
      }
      case Opcode::AArch64_ASRVXr: {  // asrv xd, xn, xm
        results[0] = logicalHelp::asrv_3gpr<int64_t>(sourceValues_);
        break;
      }
      ...
      case Opcode::AArch64_BFMWri: {  // bfm wd, wn, #immr, #imms
        results[0] = {bitmanipHelp::bfm_2imms<uint32_t>(sourceValues_, metadata,
                                                        false, false),
                      8};
        break;
      }
      case Opcode::AArch64_BFMXri: {  // bfm xd, xn, #immr, #imms
        results[0] = bitmanipHelp::bfm_2imms<uint64_t>(sourceValues_, metadata,
                                                       false, false);
        break;
      }
      case Opcode::AArch64_BICSWrs: {  // bics wd, wn, wm{, shift #amount}
        auto [result, nzcv] =
            logicalHelp::bicShift_3ops<uint32_t>(sourceValues_, metadata, true);
        results[0] = nzcv;
        results[1] = {result, 8};
        break;
      }
      case Opcode::AArch64_BICSXrs: {  // bics xd, xn, xm{, shift #amount}
        auto [result, nzcv] =
            logicalHelp::bicShift_3ops<uint64_t>(sourceValues_, metadata, true);
        results[0] = nzcv;
        results[1] = result;
        break;
      }
      ...
      case Opcode::AArch64_BICv16i8: {  // bic vd.16b, vn.16b, vm.16b
        results[0] = neonHelp::vecBic_3ops<uint8_t, 16>(sourceValues_);
        break;
      }
      case Opcode::AArch64_BICv4i32: {  // bic vd.4s, #imm{, lsl #shift}
        results[0] =
            neonHelp::vecBicShift_imm<uint32_t, 4>(sourceValues_, metadata);
        break;
      }
      case Opcode::AArch64_BICv8i16: {  // bic vd.8h, #imm{, lsl #shift}
        results[0] =
            neonHelp::vecBicShift_imm<uint16_t, 8>(sourceValues_, metadata);
        break;
      }
      case Opcode::AArch64_BICv8i8: {  // bic vd.8b, vn.8b, vm.8b
        results[0] = neonHelp::vecBic_3ops<uint8_t, 8>(sourceValues_);
        break;
      }
      case Opcode::AArch64_BIFv16i8: {  // bif vd.16b, vn.16b, vm.16b
        results[0] = neonHelp::vecBitwiseInsert<16>(sourceValues_, true);
        break;
      }
      case Opcode::AArch64_BITv16i8: {  // bit vd.16b, vn.16b, vm.16b
        results[0] = neonHelp::vecBitwiseInsert<16>(sourceValues_, false);
        break;
      }
      case Opcode::AArch64_BITv8i8: {  // bit vd.8b, vn.8b, vm.8b
        results[0] = neonHelp::vecBitwiseInsert<8>(sourceValues_, false);
        break;
      }
      ...
      case Opcode::AArch64_BSLv16i8: {  // bsl vd.16b, vn.16b, vm.16b
        results[0] = neonHelp::vecBsl<16>(sourceValues_);
        break;
      }
      ...
      case Opcode::AArch64_CBNZW: {  // cbnz wn, #imm
        auto [taken, addr] = conditionalHelp::condBranch_cmpToZero<uint32_t>(
            sourceValues_, metadata, instructionAddress_,
      ...
      case Opcode::AArch64_CCMNWi: {  // ccmn wn, #imm, #nzcv, cc
        results[0] =
            conditionalHelp::ccmn_imm<uint32_t>(sourceValues_, metadata);
        break;
      }
      case Opcode::AArch64_CCMNXi: {  // ccmn xn, #imm, #nzcv, cc
        results[0] =
            conditionalHelp::ccmn_imm<uint64_t>(sourceValues_, metadata);
        break;
      }
      case Opcode::AArch64_CCMPWi: {  // ccmp wn, #imm, #nzcv, cc
        results[0] =
            conditionalHelp::ccmp_imm<uint32_t>(sourceValues_, metadata);
        break;
      }
      case Opcode::AArch64_CCMPWr: {  // ccmp wn, wm, #nzcv, cc
        results[0] =
            conditionalHelp::ccmp_reg<uint32_t>(sourceValues_, metadata);
        break;
      }
      case Opcode::AArch64_CCMPXi: {  // ccmp xn, #imm, #nzcv, cc
        results[0] =
            conditionalHelp::ccmp_imm<uint64_t>(sourceValues_, metadata);
        break;
      }
      case Opcode::AArch64_CCMPXr: {  // ccmp xn, xm, #nzcv, cc
        results[0] =
            conditionalHelp::ccmp_reg<uint64_t>(sourceValues_, metadata);
        break;
      }
      case Opcode::AArch64_CLZXr: {  // clz xd, xn
        results[0] = arithmeticHelp::clz_reg<int64_t>(sourceValues_);
        break;
      }
      ...
      case Opcode::AArch64_CMPEQ_PPzZI_B: {  // cmpeq pd.b, pg/z, zn.b, #imm
        auto [output, nzcv] = sveHelp::sveCmpPredicated_toPred<uint8_t>(
            sourceValues_, metadata, VL_bits, true,
            [](uint8_t x, uint8_t y) -> bool { return x == y; });
        results[0] = nzcv;
        results[1] = output;
        break;
      ...
      case Opcode::AArch64_CMPEQ_PPzZZ_B: {  // cmpeq pd.b, pg/z, zn.b, zm.b
        auto [output, nzcv] = sveHelp::sveCmpPredicated_toPred<uint8_t>(
            sourceValues_, metadata, VL_bits, false,
            [](uint8_t x, uint8_t y) -> bool { return x == y; });
        results[0] = nzcv;
        results[1] = output;
        break;
      ...
      case Opcode::AArch64_CNTP_XPP_B: {  // cntp xd, pg, pn.b
        results[0] = sveHelp::sveCntp<uint8_t>(sourceValues_, VL_bits);
        break;
      }
      ...
      case Opcode::AArch64_CNTv8i8: {  // cnt vd.8b, vn.8b
        results[0] = neonHelp::vecCountPerByte<uint8_t, 8>(sourceValues_);
        break;
      }
      case Opcode::AArch64_CPY_ZPzI_B: {  // cpy zd.b, pg/z, #imm{, shift}
        results[0] =
            sveHelp::sveCpy_imm<int8_t>(sourceValues_, metadata, VL_bits);
        break;
      }
      case Opcode::AArch64_CPY_ZPzI_D: {  // cpy zd.d, pg/z, #imm{, shift}
        results[0] =
            sveHelp::sveCpy_imm<int64_t>(sourceValues_, metadata, VL_bits);
        break;
      }
      case Opcode::AArch64_CPY_ZPzI_H: {  // cpy zd.h, pg/z, #imm{, shift}
        results[0] =
            sveHelp::sveCpy_imm<int16_t>(sourceValues_, metadata, VL_bits);
        break;
      }
      case Opcode::AArch64_CPY_ZPzI_S: {  // cpy zd.s, pg/z, #imm{, shift}
        results[0] =
            sveHelp::sveCpy_imm<int32_t>(sourceValues_, metadata, VL_bits);
        break;
      }
      case Opcode::AArch64_DUPi32: {  // dup vd, vn.s[index]
        results[0] = neonHelp::vecDup_gprOrIndex<uint32_t, 1>(sourceValues_,
                                                              metadata, false);
        break;
      }
      case Opcode::AArch64_DUPi64: {  // dup vd, vn.d[index]
        results[0] = neonHelp::vecDup_gprOrIndex<uint64_t, 1>(sourceValues_,
                                                              metadata, false);
        break;
      }
      case Opcode::AArch64_CSELWr: {  // csel wd, wn, wm, cc
        results[0] = {conditionalHelp::cs_4ops<uint32_t>(
                          sourceValues_, metadata,
      ...
      case Opcode::AArch64_CSELXr: {  // csel xd, xn, xm, cc
        results[0] = conditionalHelp::cs_4ops<uint64_t>(
            sourceValues_, metadata, [](uint64_t x) -> uint64_t { return x; });
        break;
      }
      ...
      case Opcode::AArch64_CSNEGWr: {  // csneg wd, wn, wm, cc
        results[0] = {conditionalHelp::cs_4ops<int32_t>(
                          sourceValues_, metadata,
      ...
      case Opcode::AArch64_DECB_XPiI: {  // decb xdn{, pattern{, MUL #imm}}
        results[0] =
            sveHelp::sveDec_scalar<int8_t>(sourceValues_, metadata, VL_bits);
        break;
      }
      case Opcode::AArch64_DECD_XPiI: {  // decd xdn{, pattern{, MUL #imm}}
        results[0] =
            sveHelp::sveDec_scalar<int64_t>(sourceValues_, metadata, VL_bits);
        break;
      }
      ...
      case Opcode::AArch64_DUP_ZZI_D: {  // dup zd.d, zn.d[#imm]
        results[0] = sveHelp::sveDup_vecIndexed<uint64_t>(sourceValues_,
                                                          metadata, VL_bits);
        break;
      }
      ...
      case Opcode::AArch64_DUP_ZZI_S: {  // dup zd.s, zn.s[#imm]
        results[0] = sveHelp::sveDup_vecIndexed<uint32_t>(sourceValues_,
                                                          metadata, VL_bits);
        break;
      }
      case Opcode::AArch64_DUPv16i8gpr: {  // dup vd.16b, wn
        results[0] = neonHelp::vecDup_gprOrIndex<uint8_t, 16>(sourceValues_,
                                                              metadata, true);
        break;
      }
      case Opcode::AArch64_DUPv2i32gpr: {  // dup vd.2s, wn
        results[0] = neonHelp::vecDup_gprOrIndex<uint32_t, 2>(sourceValues_,
                                                              metadata, true);
        break;
      }
      ...
      case Opcode::AArch64_DUPv2i64gpr: {  // dup vd.2d, xn
        results[0] = neonHelp::vecDup_gprOrIndex<uint64_t, 2>(sourceValues_,
                                                              metadata, true);
        break;
      }
      ...
      case Opcode::AArch64_DUPv4i16gpr: {  // dup vd.4h, wn
        results[0] = neonHelp::vecDup_gprOrIndex<uint16_t, 4>(sourceValues_,
                                                              metadata, true);
        break;
      }
      case Opcode::AArch64_DUPv4i32gpr: {  // dup vd.4s, wn
        results[0] = neonHelp::vecDup_gprOrIndex<uint32_t, 4>(sourceValues_,
                                                              metadata, true);
        break;
      }
      ...
      case Opcode::AArch64_DUPv8i16gpr: {  // dup vd.8h, wn
        results[0] = neonHelp::vecDup_gprOrIndex<uint16_t, 8>(sourceValues_,
                                                              metadata, true);
        break;
      }
      ...
      case Opcode::AArch64_EXTRWrri: {  // extr wd, wn, wm, #lsb
        results[0] = {
            bitmanipHelp::extrLSB_registers<uint32_t>(sourceValues_, metadata),
            8};
        break;
      }
      case Opcode::AArch64_EXTRXrri: {  // extr xd, xn, xm, #lsb
        results[0] =
            bitmanipHelp::extrLSB_registers<uint64_t>(sourceValues_, metadata);
        break;
      }
      case Opcode::AArch64_EXTv16i8: {  // ext vd.16b, vn.16b, vm.16b, #index
        results[0] =
            neonHelp::vecExtVecs_index<uint8_t, 16>(sourceValues_, metadata);
        break;
      }
      case Opcode::AArch64_EXTv8i8: {  // ext vd.8b, vn.8b, vm.8b, #index
        results[0] =
            neonHelp::vecExtVecs_index<uint8_t, 8>(sourceValues_, metadata);
        break;
      }
      case Opcode::AArch64_FABDv2f64: {  // fabd vd.2d, vn.2d, vm.2d
        results[0] = neonHelp::vecFabd<double, 2>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FABDv4f32: {  // fabd vd.4s, vn.4s, vm.4s
        results[0] = neonHelp::vecFabd<float, 4>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FABD32: {  // fabd sd, sn, sm
        results[0] = floatHelp::fabd_3ops<float>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FABD64: {  // fabd dd, dn, dm
        results[0] = floatHelp::fabd_3ops<double>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FABSDr: {  // fabs dd, dn
        results[0] = floatHelp::fabs_2ops<double>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FABSSr: {  // fabs sd, sn
        results[0] = floatHelp::fabs_2ops<float>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FABS_ZPmZ_D: {  // fabs zd.d, pg/m, zn.d
        results[0] = sveHelp::sveFabsPredicated<double>(sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_FABS_ZPmZ_S: {  // fabs zd.s, pg/m, zn.s
        results[0] = sveHelp::sveFabsPredicated<float>(sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_FABSv2f64: {  // fabs vd.2d, vn.2d
        results[0] = neonHelp::vecFabs_2ops<double, 2>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FABSv4f32: {  // fabs vd.4s, vn.4s
        results[0] = neonHelp::vecFabs_2ops<float, 4>(sourceValues_);
        break;
      }
      ...
      case Opcode::AArch64_FADDA_VPZ_S: {  // fadda sd, pg/m, sn, zm.s
        results[0] = sveHelp::sveFaddaPredicated<float>(sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_FADDDrr: {  // fadd dd, dn, dm
        results[0] = {arithmeticHelp::add_3ops<double>(sourceValues_), 256};
        break;
      }
      case Opcode::AArch64_FADDPv2f32: {  // faddp vd.2s, vn.2s, vm.2s
        results[0] = neonHelp::vecAddp_3ops<float, 2>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FADDPv2f64: {  // faddp vd.2d, vn.2d, vm.2d
        results[0] = neonHelp::vecAddp_3ops<double, 2>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FADDPv2i32p: {  // faddp dd, vn.2s
        results[0] = neonHelp::vecSumElems_2ops<float, 2>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FADDPv2i64p: {  // faddp dd, vn.2d
        results[0] = neonHelp::vecSumElems_2ops<double, 2>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FADDPv4f32: {  // faddp vd.4s, vn.4s, vm.4s
        results[0] = neonHelp::vecAddp_3ops<float, 4>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FADDSrr: {  // fadd sd, sn, sm
        results[0] = {arithmeticHelp::add_3ops<float>(sourceValues_), 256};
        break;
      }
      case Opcode::AArch64_FADD_ZPmI_D: {  // fadd zdn.d, pg/m, zdn.d, const
        results[0] = sveHelp::sveAddPredicated_const<double>(sourceValues_,
                                                             metadata, VL_bits);
        break;
      }
      case Opcode::AArch64_FADD_ZPmI_S: {  // fadd zdn.s, pg/m, zdn.s, const
        results[0] = sveHelp::sveAddPredicated_const<float>(sourceValues_,
                                                            metadata, VL_bits);
        break;
      }
      ...
      case Opcode::AArch64_FADD_ZZZ_D: {  // fadd zd.d, zn.d, zm.d
        results[0] = sveHelp::sveAdd_3ops<double>(sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_FADD_ZZZ_S: {  // fadd zd.s, zn.s, zm.s
        results[0] = sveHelp::sveAdd_3ops<float>(sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_FADDv2f32: {  // fadd vd.2s, vn.2s, vm.2s
        results[0] = neonHelp::vecAdd_3ops<float, 2>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FADDv2f64: {  // fadd vd.2d, vn.2d, vm.2d
        results[0] = neonHelp::vecAdd_3ops<double, 2>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FADDv4f32: {  // fadd vd.4s, vn.4s, vm.4s
        results[0] = neonHelp::vecAdd_3ops<float, 4>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FCADD_ZPmZ_D: {  // fcadd zdn.d, pg/m, zdn.d, zm.d,
                                            // #imm
        results[0] = sveHelp::sveFcaddPredicated<double>(sourceValues_,
                                                         metadata, VL_bits);
        break;
      }
      case Opcode::AArch64_FCCMPDrr:     // fccmp sn, sm, #nzcv, cc
      case Opcode::AArch64_FCCMPEDrr: {  // fccmpe sn, sm, #nzcv, cc
        results[0] = floatHelp::fccmp<double>(sourceValues_, metadata);
        break;
      }
      case Opcode::AArch64_FCCMPESrr: {  // fccmpe sn, sm, #nzcv, cc
        results[0] = floatHelp::fccmp<float>(sourceValues_, metadata);
        break;
      }
      ...
      case Opcode::AArch64_FCMLA_ZPmZZ_D: {  // fcmla zda, pg/m, zn, zm, #imm
        results[0] = sveHelp::sveFcmlaPredicated<double>(sourceValues_,
                                                         metadata, VL_bits);
        break;
      }
      ...
      case Opcode::AArch64_FCMPDri: {  // fcmp dn, #imm
        results[0] = floatHelp::fcmp<double>(sourceValues_, true);
        break;
      }
      case Opcode::AArch64_FCMPDrr: {  // fcmp dn, dm
        results[0] = floatHelp::fcmp<double>(sourceValues_, false);
        break;
      }
      ...
      case Opcode::AArch64_FCMPESri: {  // fcmpe sn, #imm
        results[0] = floatHelp::fcmp<float>(sourceValues_, true);
        break;
      }
      case Opcode::AArch64_FCMPESrr: {  // fcmpe sn, sm
        results[0] = floatHelp::fcmp<float>(sourceValues_, false);
        break;
      }
      ...
      case Opcode::AArch64_FCPY_ZPmI_D: {  // fcpy zd.d, pg/m, #const
        results[0] =
            sveHelp::sveFcpy_imm<double>(sourceValues_, metadata, VL_bits);
        break;
      }
      case Opcode::AArch64_FCPY_ZPmI_S: {  // fcpy zd.s, pg/m, #const
        results[0] =
            sveHelp::sveFcpy_imm<float>(sourceValues_, metadata, VL_bits);
        break;
      }
      case Opcode::AArch64_FCSELDrrr: {  // fcsel dd, dn, dm, cond
        results[0] = {
            conditionalHelp::cs_4ops<double>(
                sourceValues_, metadata, [](double x) -> double { return x; }),
            256};
        break;
      }
      case Opcode::AArch64_FCSELSrrr: {  // fcsel sd, sn, sm, cond
        results[0] = {
            conditionalHelp::cs_4ops<float>(sourceValues_, metadata,
      ...
      case Opcode::AArch64_FCVTDSr: {  // fcvt dd, sn
        ...
        results[0] = neonHelp::vecFcvtl<double, float, 1>(sourceValues_, false);
        break;
      }
      case Opcode::AArch64_FCVTLv2i32: {  // fcvtl vd.2d, vn.2s
        results[0] = neonHelp::vecFcvtl<double, float, 2>(sourceValues_, false);
        break;
      }
      case Opcode::AArch64_FCVTLv4i32: {  // fcvtl2 vd.2d, vn.4s
        results[0] = neonHelp::vecFcvtl<double, float, 2>(sourceValues_, true);
        break;
      }
      case Opcode::AArch64_FCVTNv2i32: {  // fcvtn vd.2s, vn.2d
        results[0] = neonHelp::vecFcvtn<float, double, 2>(sourceValues_, false);
        break;
      }
      case Opcode::AArch64_FCVTNv4i32: {  // fcvtn2 vd.4s, vn.2d
        results[0] = neonHelp::vecFcvtn<float, double, 4>(sourceValues_, true);
        break;
      }
      case Opcode::AArch64_FCVTSDr: {  // fcvt sd, dn
        // TODO: Handle NaNs, denorms, and saturation?
        results[0] = neonHelp::vecFcvtl<float, double, 1>(sourceValues_, false);
        break;
      }
      ...
      case Opcode::AArch64_FCVTZS_ZPmZ_DtoD: {  // fcvtzs zd.d, pg/m, zn.d
        results[0] = sveHelp::sveFcvtzsPredicated<int64_t, double>(
            sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_FCVTZS_ZPmZ_DtoS: {  // fcvtzs zd.s, pg/m, zn.d
        results[0] = sveHelp::sveFcvtzsPredicated<int32_t, double>(
            sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_FCVTZS_ZPmZ_StoD: {  // fcvtzs zd.d, pg/m, zn.s
        results[0] = sveHelp::sveFcvtzsPredicated<int64_t, float>(sourceValues_,
                                                                  VL_bits);
        break;
      }
      case Opcode::AArch64_FCVTZS_ZPmZ_StoS: {  // fcvtzs zd.s, pg/m, zn.s
        results[0] = sveHelp::sveFcvtzsPredicated<int32_t, float>(sourceValues_,
                                                                  VL_bits);
        break;
      }
      case Opcode::AArch64_FCVTZSv2f64: {  // fcvtzs vd.2d, vn.2d
        results[0] = neonHelp::vecFcvtzs<int64_t, double, 2>(sourceValues_);
        break;
      }
      ...
      case Opcode::AArch64_FDIVDrr: {  // fdiv dd, dn, dm
        results[0] = {divideHelp::div_3ops<double>(sourceValues_), 256};
        break;
      }
      ...
      case Opcode::AArch64_FDIVSrr: {  // fdiv sd, sn, sm
        results[0] = {divideHelp::div_3ops<float>(sourceValues_), 256};
        break;
      }
      ...
      case Opcode::AArch64_FDUP_ZI_S: {  // fdup zd.s, #imm
        results[0] = sveHelp::sveDup_immOrScalar<float>(sourceValues_, metadata,
                                                        VL_bits, true);
        break;
      }
      case Opcode::AArch64_FMADDDrrr: {  // fmadd dn, dm, da
        results[0] = {multiplyHelp::madd_4ops<double>(sourceValues_), 256};
        break;
      }
      case Opcode::AArch64_FMADDSrrr: {  // fmadd sn, sm, sa
        results[0] = {multiplyHelp::madd_4ops<float>(sourceValues_), 256};
        break;
      }
      ...
      case Opcode::AArch64_FMAXNMDrr: {  // fmaxnm dd, dn, dm
        results[0] = floatHelp::fmaxnm_3ops<double>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FMAXNMPv2i64p: {  // fmaxnmp dd, vd.2d
        results[0] = neonHelp::vecMaxnmp_2ops<double, 2>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FMAXNMSrr: {  // fmaxnm sd, sn, sm
        results[0] = floatHelp::fmaxnm_3ops<float>(sourceValues_);
        break;
      }
      ...
      case Opcode::AArch64_FMINNMDrr: {  // fminnm dd, dn, dm
        results[0] = floatHelp::fminnm_3ops<double>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FMINNMPv2i64p: {  // fminnmp dd, vd.2d
        results[0] = neonHelp::vecMinv_2ops<double, 2>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FMINNMSrr: {  // fminnm sd, sn, sm
        results[0] = floatHelp::fminnm_3ops<float>(sourceValues_);
        break;
      }
      ...
      case Opcode::AArch64_FMLAv2f32: {  // fmla vd.2s, vn.2s, vm.2s
        results[0] = neonHelp::vecFmla_3vecs<float, 2>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FMLA_ZZZI_D: {  // fmla zda.d, zn.d, zm.d[index]
        results[0] = sveHelp::sveMlaIndexed_vecs<double>(sourceValues_,
                                                         metadata, VL_bits);
        break;
      }
      case Opcode::AArch64_FMLA_ZZZI_S: {  // fmla zda.s, zn.s, zm.s[index]
        results[0] = sveHelp::sveMlaIndexed_vecs<float>(sourceValues_, metadata,
                                                        VL_bits);
        break;
      }
      case Opcode::AArch64_FMLAv2f64: {  // fmla vd.2d, vn.2d, vm.2d
        results[0] = neonHelp::vecFmla_3vecs<double, 2>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FMLAv2i32_indexed: {  // fmla vd.2s, vn.2s,
                                                 // vm.2s[index]
        results[0] =
            neonHelp::vecFmlaIndexed_3vecs<float, 2>(sourceValues_, metadata);
        break;
      }
      case Opcode::AArch64_FMLAv2i64_indexed: {  // fmla vd.2d, vn.2d,
                                                 // vm.d[index]
        results[0] =
            neonHelp::vecFmlaIndexed_3vecs<double, 2>(sourceValues_, metadata);
        break;
      }
      case Opcode::AArch64_FMLAv4f32: {  // fmla vd.4s, vn.4s, vm.4s
        results[0] = neonHelp::vecFmla_3vecs<float, 4>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FMLAv4i32_indexed: {  // fmla vd.4s, vn.4s,
                                                 // vm.s[index]
        results[0] =
            neonHelp::vecFmlaIndexed_3vecs<float, 4>(sourceValues_, metadata);
        break;
      }
      ...
      case Opcode::AArch64_FMLSv2f64: {  // fmls vd.2d, vn.2d, vm.2d
        results[0] = neonHelp::vecFmls_3vecs<double, 2>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FMLSv2i64_indexed: {
        results[0] =
            neonHelp::vecFmlsIndexed_3vecs<double, 2>(sourceValues_, metadata);
        break;
      }
      case Opcode::AArch64_FMLSv4f32: {  // fmls vd.4s, vn.4s, vm.4s
        results[0] = neonHelp::vecFmls_3vecs<float, 4>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FMLSv4i32_indexed: {  // fmls vd.4s, vn.4s,
                                                 // vm.s[index]
        results[0] =
            neonHelp::vecFmlsIndexed_3vecs<float, 4>(sourceValues_, metadata);
        break;
      }
      ...
      case Opcode::AArch64_FMOVDXHighr: {  // fmov xd, vn.d[1]
        results[0] = sourceValues_[0].getAsVector<double>()[1];
        break;
      }
      case Opcode::AArch64_FMOVDXr: {  // fmov xd, dn
        results[0] = sourceValues_[0].get<double>();
        break;
      }
      ...
      case Opcode::AArch64_FMOVDr: {  // fmov dd, dn
        results[0] = {sourceValues_[0].get<double>(), 256};
        break;
      }
      case Opcode::AArch64_FMOVSWr: {  // fmov wd, sn
        results[0] = {sourceValues_[0].get<float>(), 8};
        break;
      }
      ...
      case Opcode::AArch64_FMOVSr: {  // fmov sd, sn
        results[0] = {sourceValues_[0].get<float>(), 256};
        break;
      }
      ...
      case Opcode::AArch64_FMSUBDrrr: {  // fmsub dn, dm, da
        results[0] = {multiplyHelp::msub_4ops<double>(sourceValues_), 256};
        break;
      }
      case Opcode::AArch64_FMSUBSrrr: {  // fmsub sn, sm, sa
        results[0] = {multiplyHelp::msub_4ops<float>(sourceValues_), 256};
        break;
      }
      case Opcode::AArch64_FMULDrr: {  // fmul dd, dn, dm
        results[0] = {multiplyHelp::mul_3ops<double>(sourceValues_), 256};
        break;
      }
      case Opcode::AArch64_FMULSrr: {  // fmul sd, sn, sm
        results[0] = {multiplyHelp::mul_3ops<float>(sourceValues_), 256};
        break;
      }
      case Opcode::AArch64_FMUL_ZPmI_D: {  // fmul zd.d, pg/m, zn.d, #imm
        results[0] = sveHelp::sveMulPredicated<double>(sourceValues_, metadata,
                                                       VL_bits, true);
        break;
      }
      case Opcode::AArch64_FMUL_ZPmI_S: {  // fmul zd.s, pg/m, zn.s, #imm
        results[0] = sveHelp::sveMulPredicated<float>(sourceValues_, metadata,
                                                      VL_bits, true);
        break;
      }
      ...
      case Opcode::AArch64_FMUL_ZZZ_D: {  // fmul zd.d, zn.d, zm.d
        results[0] = sveHelp::sveFmul_3ops<double>(sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_FMUL_ZZZ_S: {  // fmul zd.s, zn.s, zm.s
        results[0] = sveHelp::sveFmul_3ops<float>(sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_FMULv1i32_indexed: {  // fmul sd, sn, vm.s[index]
        results[0] =
            neonHelp::vecFmulIndexed_vecs<float, 1>(sourceValues_, metadata);
        break;
      }
      case Opcode::AArch64_FMULv1i64_indexed: {  // fmul dd, dn, vm.d[index]
        results[0] =
            neonHelp::vecFmulIndexed_vecs<double, 1>(sourceValues_, metadata);
        break;
      }
      ...
      case Opcode::AArch64_FMULv2i32_indexed: {  // fmul vd.2s, vn.2s,
                                                 // vm.s[index]
        results[0] =
            neonHelp::vecFmulIndexed_vecs<float, 2>(sourceValues_, metadata);
        break;
      }
      case Opcode::AArch64_FMULv2i64_indexed: {  // fmul vd.2d, vn.2d,
                                                 // vm.d[index]
        results[0] =
            neonHelp::vecFmulIndexed_vecs<double, 2>(sourceValues_, metadata);
        break;
      }
      ...
      case Opcode::AArch64_FMULv4i32_indexed: {  // fmul vd.4s, vn.4s,
                                                 // vm.s[index]
        results[0] =
            neonHelp::vecFmulIndexed_vecs<float, 4>(sourceValues_, metadata);
        break;
      }
      ...
      case Opcode::AArch64_FNEG_ZPmZ_D: {  // fneg zd.d, pg/m, zn.d
        results[0] = sveHelp::sveFnegPredicated<double>(sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_FNEG_ZPmZ_S: {  // fneg zd.s, pg/m, zn.s
        results[0] = sveHelp::sveFnegPredicated<float>(sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_FNEGv2f64: {  // fneg vd.2d, vn.2d
        results[0] = neonHelp::vecFneg_2ops<double, 2>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FNEGv4f32: {  // fneg vd.4s, vn.4s
        results[0] = neonHelp::vecFneg_2ops<float, 4>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FNMADDDrrr: {  // fnmadd dd, dn, dm, da
        results[0] = floatHelp::fnmadd_4ops<double>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FNMADDSrrr: {  // fnmadd sd, sn, sm, sa
        results[0] = floatHelp::fnmadd_4ops<float>(sourceValues_);
        break;
      }
      ...
      case Opcode::AArch64_FNMLS_ZPmZZ_S: {  // fnmls zd.s, pg/m, zn.s, zm.s
        results[0] = sveHelp::sveFnmlsPredicated<float>(sourceValues_, VL_bits);
        break;
      }
      ...
      case Opcode::AArch64_FNMSB_ZPmZZ_S: {  // fnmsb zdn.s, pg/m, zm.s, za.s
        results[0] = sveHelp::sveFnmsbPredicated<float>(sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_FNMSUBDrrr: {  // fnmsub dd, dn, dm, da
        results[0] = floatHelp::fnmsub_4ops<double>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FNMSUBSrrr: {  // fnmsub sd, sn, sm, sa
        results[0] = floatHelp::fnmsub_4ops<float>(sourceValues_);
        break;
      }
      ...
      case Opcode::AArch64_FRINTADr: {  // frinta dd, dn
        results[0] = {round(sourceValues_[0].get<double>()), 256};
        break;
      }
      case Opcode::AArch64_FRINTN_ZPmZ_D: {  // frintn zd.d, pg/m, zn.d
        results[0] = sveHelp::sveFrintnPredicated<int64_t, double>(
            sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_FRINTN_ZPmZ_S: {  // frintn zd.s, pg/m, zn.s
        results[0] = sveHelp::sveFrintnPredicated<int32_t, float>(sourceValues_,
                                                                  VL_bits);
        break;
      }
      case Opcode::AArch64_FRINTPDr: {  // frintp dd, dn
        results[0] = floatHelp::frintpScalar_2ops<double>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FRINTPSr: {  // frintp sd, sn
        results[0] = floatHelp::frintpScalar_2ops<float>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FRSQRTEv1i32: {  // frsqrte sd, sn
        results[0] = neonHelp::vecFrsqrte_2ops<float, 1>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FRSQRTEv1i64: {  // frsqrte dd, dn
        results[0] = neonHelp::vecFrsqrte_2ops<double, 1>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FRSQRTEv2f32: {  // frsqrte vd.2s, vn.2s
        results[0] = neonHelp::vecFrsqrte_2ops<float, 2>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FRSQRTEv2f64: {  // frsqrte vd.2d, vn.2d
        results[0] = neonHelp::vecFrsqrte_2ops<double, 2>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FRSQRTEv4f32: {  // frsqrte vd.4s, vn.4s
        results[0] = neonHelp::vecFrsqrte_2ops<float, 4>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FRSQRTS32: {  // frsqrts sd, sn, sm
        results[0] = neonHelp::vecFrsqrts_3ops<float, 1>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FRSQRTS64: {  // frsqrts dd, dn, dm
        results[0] = neonHelp::vecFrsqrts_3ops<double, 1>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FRSQRTSv2f32: {  // frsqrts vd.2s, vn.2s, vn.2s
        results[0] = neonHelp::vecFrsqrts_3ops<float, 2>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FRSQRTSv2f64: {  // frsqrts vd.2d, vn.2d, vm.2d
        results[0] = neonHelp::vecFrsqrts_3ops<double, 2>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FRSQRTSv4f32: {  // frsqrts vd.4s, vn.4s, vm.4s
        results[0] = neonHelp::vecFrsqrts_3ops<float, 4>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FSQRTDr: {  // fsqrt dd, dn
        results[0] = {::sqrt(sourceValues_[0].get<double>()), 256};
        break;
      }
      case Opcode::AArch64_FSQRTSr: {  // fsqrt sd, sn
        results[0] = {::sqrtf(sourceValues_[0].get<float>()), 256};
        break;
      }
      ...
      case Opcode::AArch64_FSQRTv2f64: {  // fsqrt vd.2d, vn.2d
        results[0] = neonHelp::vecFsqrt_2ops<double, 2>(sourceValues_);
        break;
      }
      case Opcode::AArch64_FSQRTv4f32: {  // fsqrt vd.4s, vn.4s
        results[0] = neonHelp::vecFsqrt_2ops<float, 4>(sourceValues_);
        break;
      }
      ...
      case Opcode::AArch64_FSUB_ZPmI_D: {  // fsub zdn.d, pg/m, zdn.d, #imm
        results[0] = sveHelp::sveSubPredicated_imm<double>(sourceValues_,
                                                           metadata, VL_bits);
        break;
      }
      case Opcode::AArch64_FSUB_ZPmI_S: {  // fsub zdn.s, pg/m, zdn.s, #imm
        results[0] = sveHelp::sveSubPredicated_imm<float>(sourceValues_,
                                                          metadata, VL_bits);
        break;
      }
      ...
      case Opcode::AArch64_FSUB_ZZZ_D: {  // fsub zd.d, zn.d, zm.d
        results[0] = sveHelp::sveSub_3vecs<double>(sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_FSUB_ZZZ_S: {  // fsub zd.s, zn.s, zm.s
        results[0] = sveHelp::sveSub_3vecs<float>(sourceValues_, VL_bits);
        break;
      }
      ...
      case Opcode::AArch64_INCB_XPiI: {  // incb xdn{, pattern{, #imm}}
        results[0] =
            sveHelp::sveInc_gprImm<int8_t>(sourceValues_, metadata, VL_bits);
        break;
      }
      case Opcode::AArch64_INCD_XPiI: {  // incd xdn{, pattern{, #imm}}
        results[0] =
            sveHelp::sveInc_gprImm<int64_t>(sourceValues_, metadata, VL_bits);
        break;
      }
      case Opcode::AArch64_INCD_ZPiI: {  // incd zdn.d{, pattern{, #imm}}
        results[0] =
            sveHelp::sveInc_imm<int64_t>(sourceValues_, metadata, VL_bits);
        break;
      }
      case Opcode::AArch64_INCH_XPiI: {  // inch xdn{, pattern{, #imm}}
        results[0] =
            sveHelp::sveInc_gprImm<int16_t>(sourceValues_, metadata, VL_bits);
        break;
      }
      case Opcode::AArch64_INCH_ZPiI: {  // inch zdn.h{, pattern{, #imm}}
        results[0] =
            sveHelp::sveInc_imm<int16_t>(sourceValues_, metadata, VL_bits);
        break;
      }
      case Opcode::AArch64_INCP_XP_B: {  // incp xdn, pm.b
        results[0] = sveHelp::sveIncp_gpr<uint8_t>(sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_INCP_XP_D: {  // incp xdn, pm.d
        results[0] = sveHelp::sveIncp_gpr<uint64_t>(sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_INCP_XP_H: {  // incp xdn, pm.h
        results[0] = sveHelp::sveIncp_gpr<uint16_t>(sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_INCP_XP_S: {  // incp xdn, pm.s
        results[0] = sveHelp::sveIncp_gpr<uint32_t>(sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_INCW_XPiI: {  // incw xdn{, pattern{, #imm}}
        results[0] =
            sveHelp::sveInc_gprImm<int32_t>(sourceValues_, metadata, VL_bits);
        break;
      }
      case Opcode::AArch64_INCW_ZPiI: {  // incw zdn.s{, pattern{, #imm}}
        results[0] =
            sveHelp::sveInc_imm<int32_t>(sourceValues_, metadata, VL_bits);
        break;
      }
      case Opcode::AArch64_INDEX_II_B: {  // index zd.b, #imm, #imm
        results[0] = sveHelp::sveIndex<int8_t>(sourceValues_, metadata, VL_bits,
                                               true, true);
        break;
      }
      case Opcode::AArch64_INDEX_II_D: {  // index zd.d, #imm, #imm
        results[0] = sveHelp::sveIndex<int64_t>(sourceValues_, metadata,
                                                VL_bits, true, true);
        break;
      }
      case Opcode::AArch64_INDEX_II_H: {  // index zd.h, #imm, #imm
        results[0] = sveHelp::sveIndex<int16_t>(sourceValues_, metadata,
                                                VL_bits, true, true);
        break;
      }
      case Opcode::AArch64_INDEX_II_S: {  // index zd.s, #imm, #imm
        results[0] = sveHelp::sveIndex<int32_t>(sourceValues_, metadata,
                                                VL_bits, true, true);
        break;
      }
      case Opcode::AArch64_INDEX_IR_B: {  // index zd.b, #imm, wn
        results[0] = sveHelp::sveIndex<int8_t, int32_t>(sourceValues_, metadata,
                                                        VL_bits, true, false);
        break;
      }
      case Opcode::AArch64_INDEX_IR_D: {  // index zd.d, #imm, xn
        results[0] = sveHelp::sveIndex<int64_t, int64_t>(
            sourceValues_, metadata, VL_bits, true, false);
        break;
      }
      ...
      case Opcode::AArch64_INDEX_RI_D: {  // index zd.d, xn, #imm
        results[0] = sveHelp::sveIndex<int64_t, int64_t>(
            sourceValues_, metadata, VL_bits, false, true);
        break;
      }
      ...
      case Opcode::AArch64_INDEX_RR_D: {  // index zd.d, xn, xm
        results[0] = sveHelp::sveIndex<int64_t, int64_t>(
            sourceValues_, metadata, VL_bits, false, false);
        break;
      }
      ...
      case Opcode::AArch64_INSvi32lane: {  // ins vd.s[index1], vn.s[index2]
        results[0] =
            neonHelp::vecIns_2Index<uint32_t, 4>(sourceValues_, metadata);
        break;
      }
      ...
      case Opcode::AArch64_INSvi64lane: {  // ins vd.d[index1], vn.d[index2]
        results[0] =
            neonHelp::vecIns_2Index<uint64_t, 2>(sourceValues_, metadata);
        break;
      }
      ...
      case Opcode::AArch64_LD1Onev16b_POST: {  // ld1 {vt.16b}, [xn], <#imm|xm>
        ...
        const uint64_t postIndex = (metadata.operands[2].type == ARM64_OP_REG)
                                       ...
                                       : 16;
        results[1] = sourceValues_[0].get<uint64_t>() + postIndex;
        break;
      }
      ...
      case Opcode::AArch64_LD1Fourv4s_POST: {  // ld1 {vt1.4s, vt2.4s, vt3.4s,
        ...
        const uint64_t postIndex = (metadata.operands[5].type == ARM64_OP_REG)
                                       ? sourceValues_[1].get<uint64_t>()
                                       : 64;
        results[4] = sourceValues_[0].get<uint64_t>() + postIndex;
        break;
      }
      ...
      case Opcode::AArch64_LD1Twov4s_POST: {  // ld1 {vt1.4s, vt2.4s}, [xn],
        ...
        const uint64_t postIndex = (metadata.operands[3].type == ARM64_OP_REG)
                                       ? sourceValues_[1].get<uint64_t>()
                                       : 32;
        results[2] = sourceValues_[0].get<uint64_t>() + postIndex;
        break;
      }
      ...
      case Opcode::AArch64_LD1i64_POST: {  // ld1 {vt.d}[index], [xn], #8
        ...
        results[0] = {out, 256};
        results[1] =
            sourceValues_[1].get<uint64_t>() + metadata.operands[2].imm;
        break;
      }
      ...
      case Opcode::AArch64_LD2Twov4s_POST: {  // ld2 {vt1.4s, vt2.4s}, [xn],
        ...
        results[2] = sourceValues_[2].get<uint64_t>() + offset;
        break;
      }
      ...
      case Opcode::AArch64_LDPXpost: {  // ldp xt1, xt2, [xn], #imm
        ...
        results[1] = memoryData[1].zeroExtend(dataSize_, regSize);
        results[2] =
            sourceValues_[0].get<uint64_t>() + metadata.operands[3].imm;
        break;
      }
      ...
      case Opcode::AArch64_LDPXpre: {  // ldp xt1, xt2, [xn, #imm]!
        ...
        results[1] = memoryData[1].zeroExtend(dataSize_, regSize);
        results[2] =
            sourceValues_[0].get<uint64_t>() + metadata.operands[2].mem.disp;
        break;
      }
      ...
      case Opcode::AArch64_LDRBBpre: {  // ldrb wt, [xn, #imm]!
        ...
        results[0] = memoryData[0].zeroExtend(1, 8);
        results[1] =
            sourceValues_[0].get<uint64_t>() + metadata.operands[1].mem.disp;
        break;
      }
      ...
      case Opcode::AArch64_LSL_ZZI_S: {  // lsl zd.s, zn.s, #imm
        results[0] =
            sveHelp::sveLsl_imm<uint32_t>(sourceValues_, metadata, VL_bits);
        break;
      }
      ...
      case Opcode::AArch64_MADDWrrr: {  // madd wd, wn, wm, wa
        results[0] = {multiplyHelp::madd_4ops<uint32_t>(sourceValues_), 8};
        break;
      }
      case Opcode::AArch64_MADDXrrr: {  // madd xd, xn, xm, xa
        results[0] = multiplyHelp::madd_4ops<uint64_t>(sourceValues_);
        break;
      }
      ...
      case Opcode::AArch64_MOVKWi: {  // movk wd, #imm
        results[0] = {
            arithmeticHelp::movkShift_imm<uint32_t>(sourceValues_, metadata),
            8};
        break;
      }
      case Opcode::AArch64_MOVKXi: {  // movk xd, #imm
        results[0] =
            arithmeticHelp::movkShift_imm<uint64_t>(sourceValues_, metadata);
        break;
      }
      ...
      case Opcode::AArch64_MSUBWrrr: {  // msub wd, wn, wm, wa
        results[0] = {multiplyHelp::msub_4ops<uint32_t>(sourceValues_), 8};
        break;
      }
      case Opcode::AArch64_MSUBXrrr: {  // msub xd, xn, xm, xa
        results[0] = multiplyHelp::msub_4ops<uint64_t>(sourceValues_);
        break;
      }
      ...
      case Opcode::AArch64_MUL_ZPmZ_B: {  // mul zdn.b, pg/m, zdn.b, zm.b
        results[0] = sveHelp::sveMulPredicated<uint8_t>(sourceValues_, metadata,
                                                        VL_bits, false);
        break;
      }
      ...
      case Opcode::AArch64_NEGv2i64: {  // neg vd.2d, vn.2d
        results[0] = neonHelp::vecFneg_2ops<int64_t, 2>(sourceValues_);
        break;
      }
      ...
      case Opcode::AArch64_ORRWrs: {  // orr wd, wn, wm{, shift{ #amount}}
        results[0] = {
            comparisonHelp::orrShift_3ops<uint32_t>(sourceValues_, metadata),
            8};
        break;
      }
      ...
      case Opcode::AArch64_ORRXrs: {  // orr xd, xn, xm{, shift{ #amount}}
        results[0] =
            comparisonHelp::orrShift_3ops<uint64_t>(sourceValues_, metadata);
        break;
      }
      ...
      case Opcode::AArch64_ORR_ZZZ: {  // orr zd.d, zn.d, zm.d
        results[0] = sveHelp::sveOrr_3vecs<uint64_t>(sourceValues_, VL_bits);
        break;
      }
      ...
      case Opcode::AArch64_PSEL_PPPRI_B: {  // psel pd, pn, pm.b[wa, #imm]
        results[0] =
            sveHelp::svePsel<uint8_t>(sourceValues_, metadata, VL_bits);
        break;
      }
      case Opcode::AArch64_PSEL_PPPRI_D: {  // psel pd, pn, pm.d[wa, #imm]
        results[0] =
            sveHelp::svePsel<uint64_t>(sourceValues_, metadata, VL_bits);
        break;
      }
      case Opcode::AArch64_PSEL_PPPRI_H: {  // psel pd, pn, pm.h[wa, #imm]
        results[0] =
            sveHelp::svePsel<uint16_t>(sourceValues_, metadata, VL_bits);
        break;
      }
      case Opcode::AArch64_PSEL_PPPRI_S: {  // psel pd, pn, pm.s[wa, #imm]
        results[0] =
            sveHelp::svePsel<uint32_t>(sourceValues_, metadata, VL_bits);
        break;
      }
      ...
      case Opcode::AArch64_PUNPKHI_PP: {  // punpkhi pd.h, pn.b
        results[0] = sveHelp::svePunpk(sourceValues_, VL_bits, true);
        break;
      }
      case Opcode::AArch64_PUNPKLO_PP: {  // punpklo pd.h, pn.b
        results[0] = sveHelp::svePunpk(sourceValues_, VL_bits, false);
        break;
      }
      case Opcode::AArch64_RBITWr: {  // rbit wd, wn
        results[0] = {bitmanipHelp::rbit<uint32_t>(sourceValues_, metadata), 8};
        break;
      }
      case Opcode::AArch64_RBITXr: {  // rbit xd, xn
        results[0] = bitmanipHelp::rbit<uint64_t>(sourceValues_, metadata);
        break;
      }
      ...
      case Opcode::AArch64_REV16v16i8: {  // rev16 Vd.16b, Vn.16b
        results[0] = neonHelp::vecRev<int8_t, 16, 16>(sourceValues_);
        break;
      }
      case Opcode::AArch64_REV16v8i8: {  // rev16 Vd.8b, Vn.8b
        results[0] = neonHelp::vecRev<int8_t, 16, 8>(sourceValues_);
        break;
      }
      case Opcode::AArch64_REV32v16i8: {  // rev32 Vd.16b, Vn.16b
        results[0] = neonHelp::vecRev<int8_t, 32, 16>(sourceValues_);
        break;
      }
      case Opcode::AArch64_REV32v4i16: {  // rev32 Vd.4h, Vn.4h
        results[0] = neonHelp::vecRev<int16_t, 32, 4>(sourceValues_);
        break;
      }
      case Opcode::AArch64_REV32v8i16: {  // rev32 Vd.8h, Vn.8h
        results[0] = neonHelp::vecRev<int16_t, 32, 8>(sourceValues_);
        break;
      }
      case Opcode::AArch64_REV32v8i8: {  // rev32 Vd.8b, Vn.8b
        results[0] = neonHelp::vecRev<int8_t, 32, 8>(sourceValues_);
        break;
      }
      case Opcode::AArch64_REV64v16i8: {  // rev64 Vd.16b, Vn.16b
        results[0] = neonHelp::vecRev<int8_t, 64, 16>(sourceValues_);
        break;
      }
      case Opcode::AArch64_REV64v2i32: {  // rev64 Vd.2s, Vn.2s
        results[0] = neonHelp::vecRev<int32_t, 64, 2>(sourceValues_);
        break;
      }
      case Opcode::AArch64_REV64v4i16: {  // rev64 Vd.4h, Vn.4h
        results[0] = neonHelp::vecRev<int16_t, 64, 4>(sourceValues_);
        break;
      }
      case Opcode::AArch64_REV64v4i32: {  // rev64 Vd.4s, Vn.4s
        results[0] = neonHelp::vecRev<int32_t, 64, 4>(sourceValues_);
        break;
      }
      case Opcode::AArch64_REV64v8i16: {  // rev64 Vd.8h, Vn.8h
        results[0] = neonHelp::vecRev<int16_t, 64, 8>(sourceValues_);
        break;
      }
      case Opcode::AArch64_REV64v8i8: {  // rev64 Vd.8b Vn.8b
        results[0] = neonHelp::vecRev<int8_t, 64, 8>(sourceValues_);
        break;
      }
      case Opcode::AArch64_REVXr: {  // rev xd, xn
        results[0] = bitmanipHelp::rev<uint64_t>(sourceValues_);
        break;
      }
      ...
      case Opcode::AArch64_REV_ZZ_B: {  // rev zd.b, zn.b
        results[0] = sveHelp::sveRev_vecs<uint8_t>(sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_REV_ZZ_D: {  // rev zd.d, zn.d
        results[0] = sveHelp::sveRev_vecs<uint64_t>(sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_REV_ZZ_H: {  // rev zd.h, zn.h
        results[0] = sveHelp::sveRev_vecs<uint16_t>(sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_REV_ZZ_S: {  // rev zd.s, zn.s
        results[0] = sveHelp::sveRev_vecs<uint32_t>(sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_RORVWr: {  // rorv wd, wn, wm
        results[0] = {logicalHelp::rorv_3ops<uint32_t>(sourceValues_), 8};
        break;
      }
      case Opcode::AArch64_RORVXr: {  // rorv xd, xn, xm
        results[0] = logicalHelp::rorv_3ops<uint64_t>(sourceValues_);
        break;
      }
      case Opcode::AArch64_SBCWr: {  // sbc wd, wn, wm
        results[0] = {arithmeticHelp::sbc<uint32_t>(sourceValues_), 8};
        break;
      }
      case Opcode::AArch64_SBCXr: {  // sbc xd, xn, xm
        results[0] = arithmeticHelp::sbc<uint64_t>(sourceValues_);
        break;
      }
      ...
      case Opcode::AArch64_SCVTFSWSri: {  // scvtf sd, wn, #fbits
        results[0] = floatHelp::scvtf_FixedPoint<float, int32_t>(sourceValues_,
                                                                 metadata);
        break;
      }
      case Opcode::AArch64_SCVTFSXDri: {  // scvtf dd, xn, #fbits
        results[0] = floatHelp::scvtf_FixedPoint<double, int64_t>(sourceValues_,
                                                                  metadata);
        break;
      }
      case Opcode::AArch64_SCVTFSXSri: {  // scvtf sd, xn, #fbits
        results[0] = floatHelp::scvtf_FixedPoint<float, int64_t>(sourceValues_,
                                                                 metadata);
        break;
      }
      case Opcode::AArch64_SCVTFUWDri: {  // scvtf dd, wn
        results[0] = {static_cast<double>(sourceValues_[0].get<int32_t>()),
                      256};
        break;
      }
      case Opcode::AArch64_SCVTFUWSri: {  // scvtf sd, wn
        results[0] = {static_cast<float>(sourceValues_[0].get<int32_t>()), 256};
        break;
      }
      case Opcode::AArch64_SCVTFUXDri: {  // scvtf dd, xn
        results[0] = {static_cast<double>(sourceValues_[0].get<int64_t>()),
                      256};
        break;
      }
      case Opcode::AArch64_SCVTFUXSri: {  // scvtf sd, xn
        results[0] = {static_cast<float>(sourceValues_[0].get<int64_t>()), 256};
        break;
      }
      ...
      case Opcode::AArch64_SDIVWr: {  // sdiv wd, wn, wm
        results[0] = {divideHelp::div_3ops<int32_t>(sourceValues_), 8};
        break;
      }
      case Opcode::AArch64_SDIVXr: {  // sdiv xd, xn, xm
        results[0] = {divideHelp::div_3ops<int64_t>(sourceValues_), 8};
        break;
      }
      case Opcode::AArch64_SEL_ZPZZ_D: {  // sel zd.d, pg, zn.d, zm.d
        results[0] = sveHelp::sveSel_zpzz<uint64_t>(sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_SEL_ZPZZ_S: {  // sel zd.s, pg, zn.s, zm.s
        results[0] = sveHelp::sveSel_zpzz<uint32_t>(sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_SHLd: {  // shl dd, dn #imm
        results[0] =
            neonHelp::vecShlShift_vecImm<uint64_t, 1>(sourceValues_, metadata);
        break;
      }
      case Opcode::AArch64_SHLv4i32_shift: {  // shl vd.4s, vn.4s, #imm
        results[0] =
            neonHelp::vecShlShift_vecImm<uint32_t, 4>(sourceValues_, metadata);
        break;
      }
      case Opcode::AArch64_SMADDLrrr: {  // smaddl xd, wn, wm, xa
        results[0] = multiplyHelp::maddl_4ops<int64_t, int32_t>(sourceValues_);
        break;
      }
      case Opcode::AArch64_SMAX_ZI_S: {  // smax zdn.s, zdn.s, #imm
        results[0] =
            sveHelp::sveMax_vecImm<int32_t>(sourceValues_, metadata, VL_bits);
        break;
      }
      ...
      case Opcode::AArch64_SMINV_VPZ_S: {  // sminv sd, pg, zn.s
        results[0] = sveHelp::sveSminv<int32_t>(sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_SMINVv4i32v: {  // sminv sd, vn.4s
        results[0] = neonHelp::vecMinv_2ops<int32_t, 4>(sourceValues_);
        break;
      }
      ...
      case Opcode::AArch64_SMULH_ZPmZ_H: {  // smulh zdn.h, pg/m, zdn.h, zm.h
        results[0] = sveHelp::sveMulhPredicated<int16_t, int32_t>(sourceValues_,
                                                                  VL_bits);
        break;
      }
      case Opcode::AArch64_SMULH_ZPmZ_S: {  // smulh zdn.s, pg/m, zdn.s, zm.s
        results[0] = sveHelp::sveMulhPredicated<int32_t, int64_t>(sourceValues_,
                                                                  VL_bits);
        break;
      }
      case Opcode::AArch64_SMULHrr: {  // smulh xd, xn, xm
        // TODO: signed
        results[0] = AuxFunc::mulhi(sourceValues_[0].get<uint64_t>(),
                                    sourceValues_[1].get<uint64_t>());
        break;
      }
      ...
      case Opcode::AArch64_SSHRv4i32_shift: {  // sshr vd.4s, vn.4s, #imm
        results[0] =
            neonHelp::vecSshrShift_imm<int32_t, 4>(sourceValues_, metadata);
        break;
      }
      ...
      case Opcode::AArch64_ST1Fourv16b_POST: {  // st1 {vt.16b, vt2.16b,
        ...
        const uint64_t postIndex = (metadata.operands[5].type == ARM64_OP_REG)
                                       ...
                                       : 64;
        results[0] = sourceValues_[4].get<uint64_t>() + postIndex;
        break;
      }
      ...
      case Opcode::AArch64_ST1Twov16b_POST: {  // st1 {vt.16b, vt2.16b},
        ...
        const uint64_t postIndex = (metadata.operands[3].type == ARM64_OP_REG)
                                       ...
                                       : 32;
        results[0] = sourceValues_[2].get<uint64_t>() + postIndex;
        break;
      }
      ...
      case Opcode::AArch64_ST1i16_POST: {  // st1 {vt.h}[index], [xn], xm
        ...
        results[0] = sourceValues_[1].get<uint64_t>() + offset;
        break;
      }
      ...
      case Opcode::AArch64_ST2Twov4s_POST: {  // st2 {vt1.4s, vt2.4s}, [xn],
        ...
        results[0] = sourceValues_[2].get<uint64_t>() + offset;
        break;
      }
      ...
      case Opcode::AArch64_STPXpost: {  // stp xt1, xt2, [xn], #imm
        ...
        memoryData[1] = sourceValues_[1];
        results[0] =
            sourceValues_[2].get<uint64_t>() + metadata.operands[3].imm;
        break;
      }
      ...
      case Opcode::AArch64_STPXpre: {  // stp xt1, xt2, [xn, #imm]!
        ...
        memoryData[1] = sourceValues_[1];
        results[0] =
            sourceValues_[2].get<uint64_t>() + metadata.operands[2].mem.disp;
        break;
      }
      ...
      case Opcode::AArch64_STRBBpre: {  // strb wd, [xn, #imm]!
        ...
        memoryData[0] = sourceValues_[0];
        results[0] =
            sourceValues_[1].get<uint64_t>() + metadata.operands[1].mem.disp;
        break;
      }
      ...
      case Opcode::AArch64_SUB_ZZZ_B: {  // sub zd.b, zn.b, zm.b
        results[0] = sveHelp::sveSub_3vecs<uint8_t>(sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_SUB_ZZZ_D: {  // sub zd.d, zn.d, zm.d
        results[0] = sveHelp::sveSub_3vecs<uint64_t>(sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_SUB_ZZZ_H: {  // sub zd.h, zn.h, zm.h
        results[0] = sveHelp::sveSub_3vecs<uint16_t>(sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_SUB_ZZZ_S: {  // sub zd.s, zn.s, zm.s
        results[0] = sveHelp::sveSub_3vecs<uint32_t>(sourceValues_, VL_bits);
        break;
      }
      ...
      case Opcode::AArch64_TBLv16i8Four: {  // tbl Vd.16b {Vn.16b, Vn+1.16b,
        ...
        results[0] = neonHelp::vecTbl<16>(sourceValues_, metadata);
        break;
      }
      ...
      case Opcode::AArch64_TBLv8i8Four: {  // tbl Vd.8b {Vn.16b, Vn+1.16b,
        ...
        results[0] = neonHelp::vecTbl<8>(sourceValues_, metadata);
        break;
      }
      ...
      case Opcode::AArch64_TBNZW: {  // tbnz wn, #imm, label
        auto [taken, addr] = conditionalHelp::tbnz_tbz<uint32_t>(
            sourceValues_, metadata, instructionAddress_, true);
        branchTaken_ = taken;
        branchAddress_ = addr;
        break;
      }
      ...
      case Opcode::AArch64_TBZW: {  // tbz wn, #imm, label
        auto [taken, addr] = conditionalHelp::tbnz_tbz<uint32_t>(
            sourceValues_, metadata, instructionAddress_, false);
        branchTaken_ = taken;
        branchAddress_ = addr;
        break;
      }
      ...
      case Opcode::AArch64_TRN1_ZZZ_B: {  // trn1 zd.b, zn.b, zm.b
        results[0] = sveHelp::sveTrn1_3vecs<uint8_t>(sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_TRN1_ZZZ_D: {  // trn1 zd.d, zn.d, zm.d
        results[0] = sveHelp::sveTrn1_3vecs<uint64_t>(sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_TRN1_ZZZ_H: {  // trn1 zd.h, zn.h, zm.h
        results[0] = sveHelp::sveTrn1_3vecs<uint16_t>(sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_TRN1_ZZZ_S: {  // trn1 zd.s, zn.s, zm.s
        results[0] = sveHelp::sveTrn1_3vecs<uint32_t>(sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_TRN1v16i8: {  // trn1 vd.16b, vn.16b, vm.16b
        results[0] = neonHelp::vecTrn1<uint8_t, 16>(sourceValues_);
        break;
      }
      case Opcode::AArch64_TRN1v2i32: {  // trn1 vd.2s, vn.2s, vm.2s
        results[0] = neonHelp::vecTrn1<uint32_t, 2>(sourceValues_);
        break;
      }
      case Opcode::AArch64_TRN1v2i64: {  // trn1 vd.2d, vn.2d, vm.2d
        results[0] = neonHelp::vecTrn1<uint64_t, 2>(sourceValues_);
        break;
      }
      case Opcode::AArch64_TRN1v4i16: {  // trn1 vd.4h, vn.4h, vm.4h
        results[0] = neonHelp::vecTrn1<uint16_t, 4>(sourceValues_);
        break;
      }
      case Opcode::AArch64_TRN1v4i32: {  // trn1 vd.4s, vn.4s, vm.4s
        results[0] = neonHelp::vecTrn1<uint32_t, 4>(sourceValues_);
        break;
      }
      case Opcode::AArch64_TRN1v8i16: {  // trn1 vd.8h, vn.8h, vm.8h
        results[0] = neonHelp::vecTrn1<uint16_t, 8>(sourceValues_);
        break;
      }
      case Opcode::AArch64_TRN1v8i8: {  // trn1 vd.8b, vn.8b, vm.8b
        results[0] = neonHelp::vecTrn1<uint8_t, 8>(sourceValues_);
        break;
      }
      case Opcode::AArch64_TRN2_ZZZ_B: {  // trn2 zd.b, zn.b, zm.b
        results[0] = sveHelp::sveTrn2_3vecs<uint8_t>(sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_TRN2_ZZZ_D: {  // trn2 zd.d, zn.d, zm.d
        results[0] = sveHelp::sveTrn2_3vecs<uint64_t>(sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_TRN2_ZZZ_H: {  // trn2 zd.h, zn.h, zm.h
        results[0] = sveHelp::sveTrn2_3vecs<uint16_t>(sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_TRN2_ZZZ_S: {  // trn2 zd.s, zn.s, zm.s
        results[0] = sveHelp::sveTrn2_3vecs<uint32_t>(sourceValues_, VL_bits);
        break;
      }
      case Opcode::AArch64_TRN2v16i8: {  // trn2 vd.16b, vn.16b, vm.16b
        results[0] = neonHelp::vecTrn2<uint8_t, 16>(sourceValues_);
        break;
      }
      case Opcode::AArch64_TRN2v2i32: {  // trn2 vd.2s, vn.2s, vm.2s
        results[0] = neonHelp::vecTrn2<uint32_t, 2>(sourceValues_);
        break;
      }
      case Opcode::AArch64_TRN2v2i64: {  // trn2 vd.2d, vn.2d, vm.2d
        results[0] = neonHelp::vecTrn2<uint64_t, 2>(sourceValues_);
        break;
      }
      case Opcode::AArch64_TRN2v4i16: {  // trn2 vd.4h, vn.4h, vm.4h
        results[0] = neonHelp::vecTrn2<uint16_t, 4>(sourceValues_);
        break;
      }
      case Opcode::AArch64_TRN2v4i32: {  // trn2 vd.4s, vn.4s, vm.4s
        results[0] = neonHelp::vecTrn2<uint32_t, 4>(sourceValues_);
        break;
      }
      case Opcode::AArch64_TRN2v8i16: {  // trn2 vd.8h, vn.8h, vm.8h
        results[0] = neonHelp::vecTrn2<uint16_t, 8>(sourceValues_);
        break;
      }
      case Opcode::AArch64_TRN2v8i8: {  // trn2 vd.8b, vn.8b, vm.8b
        results[0] = neonHelp::vecTrn2<uint8_t, 8>(sourceValues_);
        break;
      }
      ...
      case Opcode::AArch64_UCVTFUWDri: {  // ucvtf dd, wn
        results[0] = {static_cast<double>(sourceValues_[0].get<uint32_t>()),
                      256};
        break;
      }
      case Opcode::AArch64_UCVTFUWSri: {  // ucvtf sd, wn
        results[0] = {static_cast<float>(sourceValues_[0].get<uint32_t>()),
                      256};
        break;
      }
      case Opcode::AArch64_UCVTFUXDri: {  // ucvtf dd, xn
        results[0] = {static_cast<double>(sourceValues_[0].get<uint64_t>()),
                      256};
        break;
      }
      case Opcode::AArch64_UCVTFUXSri: {  // ucvtf sd, xn
        results[0] = {static_cast<float>(sourceValues_[0].get<uint64_t>()),
                      256};
        break;
      }
      ...
      case Opcode::AArch64_UDIVWr: {  // udiv wd, wn, wm
        results[0] = {divideHelp::div_3ops<uint32_t>(sourceValues_), 8};
        break;
      }
      case Opcode::AArch64_UDIVXr: {  // udiv xd, xn, xm
        results[0] = {divideHelp::div_3ops<uint64_t>(sourceValues_), 8};
        break;
      }
      ...
      case Opcode::AArch64_UMAXPv16i8: {  // umaxp vd.16b, vn.16b, vm.16b
        results[0] = neonHelp::vecUMaxP<uint8_t, 16>(sourceValues_);
        break;
      }
      case Opcode::AArch64_UMINPv16i8: {  // uminp vd.16b, vn.16b, vm.16b
        results[0] = neonHelp::vecUMinP<uint8_t, 16>(sourceValues_);
        break;
      }
      ...
      case Opcode::AArch64_UQDECD_WPiI: {  // uqdecd wd{, pattern{, MUL #imm}}
        results[0] =
            sveHelp::sveUqdec<uint32_t, 64u>(sourceValues_, metadata, VL_bits);
        break;
      }
      case Opcode::AArch64_UQDECD_XPiI: {  // uqdecd xd{, pattern{, MUL #imm}}
        results[0] =
            sveHelp::sveUqdec<uint64_t, 64u>(sourceValues_, metadata, VL_bits);
        break;
      }
      case Opcode::AArch64_UQDECH_XPiI: {  // uqdech xd{, pattern{, MUL #imm}}
        results[0] =
            sveHelp::sveUqdec<uint64_t, 16u>(sourceValues_, metadata, VL_bits);
        break;
      }
      case Opcode::AArch64_UQDECW_XPiI: {  // uqdecw xd{, pattern{, MUL #imm}}
        results[0] =
            sveHelp::sveUqdec<uint64_t, 32u>(sourceValues_, metadata, VL_bits);
        break;
      }
      ...
      case Opcode::AArch64_UUNPKHI_ZZ_D: {  // uunpkhi zd.d, zn.s
        results[0] = sveHelp::sveUnpk_vecs<uint64_t, uint32_t>(sourceValues_,
                                                               VL_bits, true);
        break;
      }
      case Opcode::AArch64_UUNPKHI_ZZ_H: {  // uunpkhi zd.h, zn.b
        results[0] = sveHelp::sveUnpk_vecs<uint16_t, uint8_t>(sourceValues_,
                                                              VL_bits, true);
        break;
      }
      case Opcode::AArch64_UUNPKHI_ZZ_S: {  // uunpkhi zd.s, zn.h
        results[0] = sveHelp::sveUnpk_vecs<uint32_t, uint16_t>(sourceValues_,
                                                               VL_bits, true);
        break;
      }
      ...
      case Opcode::AArch64_UZP1v16i8: {  // uzp1 vd.16b, vn.16b, vm.16b
        results[0] = neonHelp::vecUzp<int8_t, 16>(sourceValues_, true);
        break;
      }
      case Opcode::AArch64_UZP1v2i32: {  // uzp1 vd.2s, vn.2s, vm.2s
        results[0] = neonHelp::vecUzp<int32_t, 2>(sourceValues_, true);
        break;
      }
      case Opcode::AArch64_UZP1v2i64: {  // uzp1 vd.2d, vn.2d, vm.2d
        results[0] = neonHelp::vecUzp<int64_t, 2>(sourceValues_, true);
        break;
      }
      case Opcode::AArch64_UZP1v4i16: {  // uzp1 vd.4h, vn.4h, vm.4h
        results[0] = neonHelp::vecUzp<int16_t, 4>(sourceValues_, true);
        break;
      }
      case Opcode::AArch64_UZP1v4i32: {  // uzp1 vd.4s, vn.4s, vm.4s
        results[0] = neonHelp::vecUzp<int32_t, 4>(sourceValues_, true);
        break;
      }
      case Opcode::AArch64_UZP1v8i16: {  // uzp1 vd.8h, vn.8h, vm.8h
        results[0] = neonHelp::vecUzp<int16_t, 8>(sourceValues_, true);
        break;
      }
      case Opcode::AArch64_UZP1v8i8: {  // uzp1 vd.8b, vn.8b, vm.8b
        results[0] = neonHelp::vecUzp<int8_t, 8>(sourceValues_, true);
        break;
      }
      case Opcode::AArch64_UZP2v16i8: {  // uzp2 vd.16b, vn.16b, vm.16b
        results[0] = neonHelp::vecUzp<int8_t, 16>(sourceValues_, false);
        break;
      }
      case Opcode::AArch64_UZP2v2i32: {  // uzp2 vd.2s, vn.2s, vm.2s
        results[0] = neonHelp::vecUzp<int32_t, 2>(sourceValues_, false);
        break;
      }
      case Opcode::AArch64_UZP2v2i64: {  // uzp2 vd.2d, vn.2d, vm.2d
        results[0] = neonHelp::vecUzp<int64_t, 2>(sourceValues_, false);
        break;
      }
      case Opcode::AArch64_UZP2v4i16: {  // uzp2 vd.4h, vn.4h, vm.4h
        results[0] = neonHelp::vecUzp<int16_t, 4>(sourceValues_, false);
        break;
      }
      case Opcode::AArch64_UZP2v4i32: {  // uzp2 vd.4s, vn.4s, vm.4s
        results[0] = neonHelp::vecUzp<int32_t, 4>(sourceValues_, false);
        break;
      }
      case Opcode::AArch64_UZP2v8i16: {  // uzp2 vd.8h, vn.8h, vm.8h
        results[0] = neonHelp::vecUzp<int16_t, 8>(sourceValues_, false);
        break;
      }
      case Opcode::AArch64_UZP2v8i8: {  // uzp2 vd.8b, vn.8b, vm.8b
        results[0] = neonHelp::vecUzp<int8_t, 8>(sourceValues_, false);
        break;
      }
      ...
      case Opcode::AArch64_ZIP1v16i8: {  // zip1 vd.16b, vn.16b, vm.16b
        results[0] = neonHelp::vecZip<uint8_t, 16>(sourceValues_, false);
        break;
      }
      case Opcode::AArch64_ZIP1v2i32: {  // zip1 vd.2s, vn.2s, vm.2s
        results[0] = neonHelp::vecZip<uint32_t, 2>(sourceValues_, false);
        break;
      }
      case Opcode::AArch64_ZIP1v2i64: {  // zip1 vd.2d, vn.2d, vm.2d
        results[0] = neonHelp::vecZip<uint64_t, 2>(sourceValues_, false);
        break;
      }
      case Opcode::AArch64_ZIP1v4i16: {  // zip1 vd.4h, vn.4h, vm.4h
        results[0] = neonHelp::vecZip<uint16_t, 4>(sourceValues_, false);
        break;
      }
      case Opcode::AArch64_ZIP1v4i32: {  // zip1 vd.4s, vn.4s, vm.4s
        results[0] = neonHelp::vecZip<uint32_t, 4>(sourceValues_, false);
        break;
      }
      case Opcode::AArch64_ZIP1v8i16: {  // zip1 vd.8h, vn.8h, vm.8h
        results[0] = neonHelp::vecZip<uint16_t, 8>(sourceValues_, false);
        break;
      }
      case Opcode::AArch64_ZIP1v8i8: {  // zip1 vd.8b, vn.8b, vm.8b
        results[0] = neonHelp::vecZip<uint8_t, 8>(sourceValues_, false);
        break;
      }
      ...
      case Opcode::AArch64_ZIP2v16i8: {  // zip2 vd.16b, vn.16b, vm.16b
        results[0] = neonHelp::vecZip<uint8_t, 16>(sourceValues_, true);
        break;
      }
      case Opcode::AArch64_ZIP2v2i32: {  // zip2 vd.2s, vn.2s, vm.2s
        results[0] = neonHelp::vecZip<uint32_t, 2>(sourceValues_, true);
        break;
      }
      case Opcode::AArch64_ZIP2v2i64: {  // zip2 vd.2d, vn.2d, vm.2d
        results[0] = neonHelp::vecZip<uint64_t, 2>(sourceValues_, true);
        break;
      }
      case Opcode::AArch64_ZIP2v4i16: {  // zip2 vd.4h, vn.4h, vm.4h
        results[0] = neonHelp::vecZip<uint16_t, 4>(sourceValues_, true);
        break;
      }
      case Opcode::AArch64_ZIP2v4i32: {  // zip2 vd.4s, vn.4s, vm.4s
        results[0] = neonHelp::vecZip<uint32_t, 4>(sourceValues_, true);
        break;
      }
      case Opcode::AArch64_ZIP2v8i16: {  // zip2 vd.8h, vn.8h, vm.8h
        results[0] = neonHelp::vecZip<uint16_t, 8>(sourceValues_, true);
        break;
      }
      case Opcode::AArch64_ZIP2v8i8: {  // zip2 vd.8b, vn.8b, vm.8b
        results[0] = neonHelp::vecZip<uint8_t, 8>(sourceValues_, true);
        break;
      }
