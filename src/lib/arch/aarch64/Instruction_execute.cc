  ...
  if (isMicroOp_) {
    ...
    switch (metadata_.opcode) {
      case Opcode::AArch64_ADCXr: {  // adc xd, xn, xm
        ...
        results_[0] = result;
        if (print) {
          std::cout << instructionAddress_ << " AArch64_ADCXr" << std::endl;
        }
        break;
      }
      case Opcode::AArch64_ADDPL_XXI: {  // addpl xd, xn, #imm
        ...
        results_[0] = x + (PL * y);
        if (print) {
          std::cout << instructionAddress_ << " AArch64_ADDPLXXI" << std::endl;
        }
        break;
      }
      case Opcode::AArch64_ADDPv16i8: {  // addp vd.16b, vn.16b, vm.16b
        ...
        if (print) {
          std::cout << instructionAddress_ << " AArch64_ADDPv16i8" << std::endl;
        }
        break;
      }
      ...
      case Opcode::AArch64_ADDSWri: {  // adds wd, wn, #imm{, shift}
        ...
        results_[1] = {result, 8};
        if (print) {
          std::cout << instructionAddress_ << " AArch64_ADDSWri" << std::endl;
        }
        break;
      }
      case Opcode::AArch64_ADDSWrs: {  // adds wd, wn, wm{, shift}
        ...
        results_[1] = {result, 8};
        if (print) {
          std::cout << instructionAddress_ << " AArch64_ADDSWrs" << std::endl;
        }
        break;
      }
      case Opcode::AArch64_ADDSWrx: {  // adds wd, wn, wm{, extend {#amount}}
        ...
        results_[1] = {result, 8};
        if (print) {
          std::cout << instructionAddress_ << " AArch64_ADDSWrx" << std::endl;
        }
        break;
      }
      case Opcode::AArch64_ADDSXri: {  // adds xd, xn, #imm{, shift}
        ...
        results_[1] = result;
        if (print) {
          std::cout << instructionAddress_ << " AArch64_ADDSXri" << std::endl;
        }
        break;
      }
      case Opcode::AArch64_ADDSXrs: {  // adds xd, xn, xm{, shift}
        ...
        results_[1] = result;
        if (print) {
          std::cout << instructionAddress_ << " AArch64_ADDSXrs" << std::endl;
        }
        break;
      }
      ...
      case Opcode::AArch64_ADDWri: {  // add wd, wn, #imm{, shift}
        ...
        results_[0] = {result, 8};
        if (print) {
          std::cout << instructionAddress_ << " AArch64_ADDWri" << std::endl;
        }
        break;
      }
      case Opcode::AArch64_ADDWrs: {  // add wd, wn, wm{, shift #amount}
        ...
        results_[0] = {result, 8};
        if (print) {
          std::cout << instructionAddress_ << " AArch64_ADDWrs" << std::endl;
        }
        break;
      }
      case Opcode::AArch64_ADDWrx: {  // add wd, wn, wm{, extend #amount}
        ...
        results_[0] = {result, 8};
        if (print) {
          std::cout << instructionAddress_ << " AArch64_ADDWrx" << std::endl;
        }
        break;
      }
      case Opcode::AArch64_ADDXri: {  // add xd, xn, #imm{, shift}
        ...
        results_[0] = result;
        if (print) {
          std::cout << instructionAddress_ << " AArch64_ADDXri" << std::endl;
        }
        break;
      }
      case Opcode::AArch64_ADDXrs: {  // add xd, xn, xm, {shift #amount}
        ...
        results_[0] = result;
        if (print) {
          std::cout << instructionAddress_ << " AArch64_ADDXrs" << std::endl;
        }
        break;
      }
      ...
      case Opcode::AArch64_ADDXrx64: {  // add xd, xn, xm{, extend {#amount}}
        ...
        results_[0] = result;
        if (print) {
          std::cout << instructionAddress_ << " AArch64_ADDXrx" << std::endl;
        }
        break;
      }
      case Opcode::AArch64_ADD_ZI_B: {  // add zdn.b, zdn.b, imm{, shift}
        ...
        if (print) {
          std::cout << instructionAddress_ << " AArch64_ADD_ZI_B" << std::endl;
        }
        break;
      }
      case Opcode::AArch64_ADD_ZI_D: {  // add zdn.d, zdn.d, imm{, shift}
        ...
        if (print) {
          std::cout << instructionAddress_ << " AArch64_ADD_ZI_D" << std::endl;
        }
        break;
      }
      case Opcode::AArch64_ADD_ZI_H: {  // add zdn.h zdn.h, imm{, shift}
        ...
        if (print) {
          std::cout << instructionAddress_ << " AArch64_ADD_ZI_H" << std::endl;
        }
        break;
      }
      case Opcode::AArch64_ADD_ZI_S: {  // add zdn.s, zdn.s, imm{, shift}
        ...
        if (print) {
          std::cout << instructionAddress_ << " AArch64_ADD_ZI_S" << std::endl;
        }
        break;
      }
      ...
      case Opcode::AArch64_ADDv16i8: {  // add vd.16b, vn.16b, vm.16b
        ...
        if (print) {
          std::cout << instructionAddress_ << " AArch64_ADDv16i8" << std::endl;
        }
        break;
      }
      case Opcode::AArch64_ADDv1i64: {  // add dd, dn, dm
        ...
        if (print) {
          std::cout << instructionAddress_ << " AArch64_ADDv1i64" << std::endl;
        }
        break;
      }
      case Opcode::AArch64_ADDv2i32: {  // add vd.2s, vn.2s, vm.2s
        ...
        if (print) {
          std::cout << instructionAddress_ << " AArch64_ADDv2i32" << std::endl;
        }
        break;
      }
      case Opcode::AArch64_ADDv2i64: {  // add vd.2d, vn.2d, vm.2d
        ...
        if (print) {
          std::cout << instructionAddress_ << " AArch64_ADDv2i64" << std::endl;
        }
        break;
      }
      case Opcode::AArch64_ADDv4i16: {  // add vd.4h, vn.4h, vm.4h
        ...
        if (print) {
          std::cout << instructionAddress_ << " AArch64_ADDv4i16" << std::endl;
        }
        break;
      }
      case Opcode::AArch64_ADDv4i32: {  // add vd.4s, vn.4s, vm.4s
        ...
        if (print) {
          std::cout << instructionAddress_ << " AArch64_ADDv4i32" << std::endl;
        }
        break;
      }
      case Opcode::AArch64_ADDv8i16: {  // add vd.8h, vn.8h, vm.8h
        ...
        if (print) {
          std::cout << instructionAddress_ << " AArch64_ADDv8i16" << std::endl;
        }
        break;
      }
      case Opcode::AArch64_ADDv8i8: {  // add vd.8b, vn.8b, vm.8b
        ...
        if (print) {
          std::cout << instructionAddress_ << " AArch64_ADDv8i8" << std::endl;
        }
        break;
      }
      case Opcode::AArch64_ADR: {  // adr xd, #imm
        ...
        if (print) {
          std::cout << instructionAddress_ << " AArch64_ADR" << std::endl;
        }
        break;
      }
      case Opcode::AArch64_ADRP: {  // adrp xd, #imm
        ...
        if (print) {
          std::cout << instructionAddress_ << " AArch64_ADRP" << std::endl;
        }
        break;
      }
