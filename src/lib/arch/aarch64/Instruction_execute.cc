...
void Instruction::execute() {
  ...
  switch (metadata.opcode) {
    ...
    case Opcode::AArch64_FADDPv2f64: {
      return executionNYI();
      break;
    }
    ...
    case Opcode::AArch64_FADDPv4f32: {
      return executionNYI();
      break;
    }
    ...
    case Opcode::AArch64_FCMGEv2f32: {
      return executionNYI();
      break;
    }
    case Opcode::AArch64_FCMGEv2f64: {
      return executionNYI();
      break;
    }
    ...
    case Opcode::AArch64_FCMGEv4f32: {
      return executionNYI();
      break;
    }
    ...
    case Opcode::AArch64_FCMGTv2i32rz: {
      return executionNYI();
      break;
    }
    case Opcode::AArch64_FCMGTv2i64rz: {
      return executionNYI();
      break;
    }
    ...
    case Opcode::AArch64_FCVTASUWDr: {
      return executionNYI();
      break;
    }
    ...
    case Opcode::AArch64_FCVTASUXDr: {
      return executionNYI();
      break;
    }
    ...
    case Opcode::AArch64_FCVTLv2i32: {
      return executionNYI();
      break;
    }
    ...
    case Opcode::AArch64_FCVTLv4i32: {
      return executionNYI();
      break;
    }
    ...
    case Opcode::AArch64_FCVTNv4i32: {
      return executionNYI();
      break;
    }
    ...
    case Opcode::AArch64_FCVTZUUWDr: {
      return executionNYI();
      break;
    }
    ...
    case Opcode::AArch64_FCVTZUUWSr: {
      return executionNYI();
      break;
    }
    case Opcode::AArch64_FCVTZUUXDr: {
      return executionNYI();
      break;
    }
    ...
    case Opcode::AArch64_FCVTZUUXSr: {
      return executionNYI();
      break;
    }
    ...
    case Opcode::AArch64_FMOVv2f32_ns: {
      return executionNYI();
      break;
    }
    ...
    case Opcode::AArch64_FRSQRTSv2f32: {
      return executionNYI();
      break;
    }
    case Opcode::AArch64_FRSQRTSv2f64: {
      return executionNYI();
      break;
    }
    ...
    case Opcode::AArch64_FSQRTv2f64: {
      return executionNYI();
      break;
    }
    ...
    case Opcode::AArch64_INSvi16gpr: {
      return executionNYI();
      break;
    }
    ...
    case Opcode::AArch64_INSvi32gpr: {
      return executionNYI();
      break;
    }
    ...
    case Opcode::AArch64_INSvi64gpr: {
      return executionNYI();
      break;
    }
    ...
    case Opcode::AArch64_LDARW: {
      return executionNYI();
      break;
    }
    case Opcode::AArch64_LDARX: {
      return executionNYI();
      break;
    }
    ...
    case Opcode::AArch64_LDAXRW: {
      return executionNYI();
      break;
    }
    case Opcode::AArch64_LDAXRX: {
      return executionNYI();
      break;
    }
    ...
    case Opcode::AArch64_LDRSBWroX: {
      return executionNYI();
      break;
    }
    case Opcode::AArch64_LDRSBWui: {
      return executionNYI();
      break;
    }
    ...
    case Opcode::AArch64_LDRSHWroW: {
      return executionNYI();
      break;
    }
    case Opcode::AArch64_LDRSHWroX: {
      return executionNYI();
      break;
    }
    case Opcode::AArch64_LDRSHWui: {
      return executionNYI();
      break;
    }
    ...
    case Opcode::AArch64_LDRSHXroW: {
      return executionNYI();
      break;
    }
    case Opcode::AArch64_LDRSHXroX: {
      return executionNYI();
      break;
    }
    case Opcode::AArch64_LDRSHXui: {
      return executionNYI();
      break;
    }
    case Opcode::AArch64_LDRSWl: {
      return executionNYI();
      break;
    }
    ...
    case Opcode::AArch64_LDURDi: {
      return executionNYI();
      break;
    }
    case Opcode::AArch64_LDURHHi: {
      return executionNYI();
      break;
    }
    ...
    case Opcode::AArch64_LDXRW: {
      return executionNYI();
      break;
    }
    case Opcode::AArch64_LDXRX: {
      return executionNYI();
      break;
    }
    ...
    case Opcode::AArch64_STLRW: {
      return executionNYI();
      break;
    }
    case Opcode::AArch64_STLRX: {
      return executionNYI();
      break;
    }
    ...
    case Opcode::AArch64_WHILELO_PWW_B: {  // whilelo pd.b, wn, wm
      auto [output, nzcv] =
          sveHelp::sveWhilelo<uint32_t, uint8_t>(operands, VL_bits);
      results[0] = nzcv;
      results[1] = output;
      break;
    }
    case Opcode::AArch64_WHILELO_PWW_D: {  // whilelo pd.d, wn, wm
      auto [output, nzcv] =
          sveHelp::sveWhilelo<uint32_t, uint64_t>(operands, VL_bits);
      results[0] = nzcv;
      results[1] = output;
      break;
    }
    case Opcode::AArch64_WHILELO_PWW_H: {  // whilelo pd.h, wn, wm
      auto [output, nzcv] =
          sveHelp::sveWhilelo<uint32_t, uint16_t>(operands, VL_bits);
      results[0] = nzcv;
      results[1] = output;
      break;
    }
    case Opcode::AArch64_WHILELO_PWW_S: {  // whilelo pd.s, wn, wm
      auto [output, nzcv] =
          sveHelp::sveWhilelo<uint32_t, uint32_t>(operands, VL_bits);
      results[0] = nzcv;
      results[1] = output;
      break;
    }
    case Opcode::AArch64_WHILELO_PXX_B: {  // whilelo pd.b, xn, xm
      auto [output, nzcv] =
          sveHelp::sveWhilelo<uint64_t, uint8_t>(operands, VL_bits);
      results[0] = nzcv;
      results[1] = output;
      break;
    }
    case Opcode::AArch64_WHILELO_PXX_D: {  // whilelo pd.d, xn, xm
      auto [output, nzcv] =
          sveHelp::sveWhilelo<uint64_t, uint64_t>(operands, VL_bits);
      results[0] = nzcv;
      results[1] = output;
      break;
    }
    case Opcode::AArch64_WHILELO_PXX_H: {  // whilelo pd.h, xn, xm
      auto [output, nzcv] =
          sveHelp::sveWhilelo<uint64_t, uint16_t>(operands, VL_bits);
      results[0] = nzcv;
      results[1] = output;
      break;
    }
    case Opcode::AArch64_WHILELO_PXX_S: {  // whilelo pd.s, xn, xm
      auto [output, nzcv] =
          sveHelp::sveWhilelo<uint64_t, uint32_t>(operands, VL_bits);
      results[0] = nzcv;
      results[1] = output;
      break;
    }
