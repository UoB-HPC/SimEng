...
Instruction MicroDecoder::createMovUop(const Architecture& architecture,
  ...
  microMetadataCache_.emplace_front(mov_metadata);
  Instruction mov(
...
Instruction MicroDecoder::createFaddpUop(const Architecture& architecture,
  ...
  microMetadataCache_.emplace_front(faddp_metadata);
  Instruction faddp(
      architecture, microMetadataCache_.front(),
...
Instruction MicroDecoder::createFcvtUop(const Architecture& architecture,
  ...
  microMetadataCache_.emplace_front(fcvt_metadata);
  Instruction fcvt(architecture, microMetadataCache_.front(),
...
Instruction MicroDecoder::createFmlaUop(const Architecture& architecture,
  ...
  microMetadataCache_.emplace_front(fmla_metadata);
  Instruction fmla(
      architecture, microMetadataCache_.front(),
...
Instruction MicroDecoder::createFmulUop(const Architecture& architecture,
  ...
  microMetadataCache_.emplace_front(fmul_metadata);
  Instruction fmul(
      architecture, microMetadataCache_.front(),
...
Instruction MicroDecoder::createScvtUop(const Architecture& architecture,
  ...
  microMetadataCache_.emplace_front(scvt_metadata);
  Instruction scvt(architecture, microMetadataCache_.front(),
