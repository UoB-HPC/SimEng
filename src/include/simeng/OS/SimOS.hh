...
class SimOS {
 public:
  ...
  /** Recieve the syscall from a core and pass onto the syscall handler. */
  void recieveSyscall(const SyscallInfo syscallInfo) const;

  /** Send the syscall result generated by the SyscallHandler to the relevant
   * core. */
  void sendSyscallResult(SyscallResult result);
