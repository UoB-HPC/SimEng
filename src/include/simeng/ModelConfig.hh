...
#define DEFAULT_CONFIG                                                         \
  ("{Core: {Simulation-Mode: inorderpipelined, Clock-Frequency: 2.5, "         \
   ...
   "RAS-entries: 5, Fallback-Static-Predictor: 2}, L1-Cache: "                 \
   ...
   "CPU-Info: {Generate-Special-Dir: F, Core-Count: 1, Socket-Count: 1, SMT: " \
   "1, BogoMIPS: 200.00, Features: fp asimd evtstrm atomics cpuid, "           \
