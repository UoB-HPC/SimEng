...
std::map<std::string, uint16_t> group_mapping = {
    ...
    {"INT_LOAD", simeng::arch::aarch64::InstructionGroups::INT_LOAD},
    {"FLOAT_LOAD", simeng::arch::aarch64::InstructionGroups::FLOAT_LOAD},
    {"VECTOR_LOAD", simeng::arch::aarch64::InstructionGroups::VECTOR_LOAD},
    {"SVE_LOAD", simeng::arch::aarch64::InstructionGroups::SVE_LOAD},
