...
const std::unordered_map<uint16_t, std::vector<uint16_t>> groupInheritance = {
    ...
    {InstructionGroups::INT_SIMPLE,
     {InstructionGroups::INT_ARTH, InstructionGroups::INT_LOGICAL,
    ...
    {InstructionGroups::FP_ARTH,
     {InstructionGroups::SCALAR_ARTH, InstructionGroups::VECTOR_ARTH}},
    ...
    {InstructionGroups::FP_LOGICAL_NOSHIFT,
    ...
    {InstructionGroups::SCALAR_SIMPLE,
     {InstructionGroups::SCALAR_ARTH, InstructionGroups::SCALAR_LOGICAL,
      InstructionGroups::SCALAR_CMP, InstructionGroups::SCALAR_CVT}},
    ...
    {InstructionGroups::VECTOR_SIMPLE,
     {InstructionGroups::VECTOR_ARTH, InstructionGroups::VECTOR_LOGICAL,
      InstructionGroups::VECTOR_CMP, InstructionGroups::VECTOR_CVT}},
    ...
    {InstructionGroups::SVE_SIMPLE,
     {InstructionGroups::SVE_ARTH, InstructionGroups::SVE_LOGICAL,
