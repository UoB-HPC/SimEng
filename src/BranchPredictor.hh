...
struct BranchPrediction {
  ...
  /** The branch instruction's target address. If `taken = false`, the value will be ignored. */
  uint64_t target;
};
...
class BranchPredictor {
 public:
  ...
  /** Provide branch results to update the prediction model for the specified instruction address. */
