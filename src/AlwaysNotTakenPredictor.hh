...
class AlwaysNotTakenPredictor : public BranchPredictor {
 public:
  /** Generate a branch prediction for the specified instruction address; will always predict not taken. */
  BranchPrediction predict(uint64_t instructionAddress) override;

  /** Provide branch results to update the prediction model for the specified instruction address. As this model is static, this does nothing. */
