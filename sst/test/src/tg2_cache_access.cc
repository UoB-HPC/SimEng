...
TEST_CASE(TG2, "load_after_store_on_same_address_should_be_return_from_cache",
  ...
  EXPECT_LT(lastLoadCycleLatency, firstLoadCycleLatency);
  EXPECT_EQ(1024, firstLoadData);
  EXPECT_EQ(1024, lastLoadData);
}
