#ifndef _H_SST_NEXT_K_BLOCK_PREFETCH
#define _H_SST_NEXT_K_BLOCK_PREFETCH
...
class NextKBlockPrefetcher : public SST::MemHierarchy::CacheListener {
 public:
  NextKBlockPrefetcher(ComponentId_t id, Params& params);
  ~NextKBlockPrefetcher();
  ...
  SST_ELI_REGISTER_SUBCOMPONENT_DERIVED(NextKBlockPrefetcher, "cassini",
                                        "NextKBlockPrefetcher",
                                        SST_ELI_ELEMENT_VERSION(1, 0, 0),
                                        "Next K-Block Prefetcher",
